...
package Interfaces.STM32.DMA is
   ...
   type ISR_Register is record
      GIF1           : ISR_GIF1_Field := 16#0#;
      TCIF1          : ISR_TCIF1_Field := 16#0#;
      HTIF1          : ISR_HTIF1_Field := 16#0#;
      TEIF1          : ISR_TEIF1_Field := 16#0#;
      GIF2           : ISR_GIF2_Field := 16#0#;
      TCIF2          : ISR_TCIF2_Field := 16#0#;
      HTIF2          : ISR_HTIF2_Field := 16#0#;
      TEIF2          : ISR_TEIF2_Field := 16#0#;
      GIF3           : ISR_GIF3_Field := 16#0#;
      TCIF3          : ISR_TCIF3_Field := 16#0#;
      HTIF3          : ISR_HTIF3_Field := 16#0#;
      TEIF3          : ISR_TEIF3_Field := 16#0#;
      GIF4           : ISR_GIF4_Field := 16#0#;
      TCIF4          : ISR_TCIF4_Field := 16#0#;
      HTIF4          : ISR_HTIF4_Field := 16#0#;
      TEIF4          : ISR_TEIF4_Field := 16#0#;
      GIF5           : ISR_GIF5_Field := 16#0#;
      TCIF5          : ISR_TCIF5_Field := 16#0#;
      HTIF5          : ISR_HTIF5_Field := 16#0#;
      TEIF5          : ISR_TEIF5_Field := 16#0#;
      GIF6           : ISR_GIF6_Field := 16#0#;
      TCIF6          : ISR_TCIF6_Field := 16#0#;
      HTIF6          : ISR_HTIF6_Field := 16#0#;
      TEIF6          : ISR_TEIF6_Field := 16#0#;
      GIF7           : ISR_GIF7_Field := 16#0#;
      TCIF7          : ISR_TCIF7_Field := 16#0#;
      HTIF7          : ISR_HTIF7_Field := 16#0#;
      TEIF7          : ISR_TEIF7_Field := 16#0#;
      --  unspecified
   ...
   subtype CNDTR_NDTR_Field is Interfaces.Bit_Types.Short;
