...
package Security is
   ...
   SC_PAIRING_NOT_SUPPORTED        : constant UInt8 := 16#00#;
   SC_PAIRING_OPT_SUPPORTED        : constant UInt8 := 16#01#;
   SC_PAIRING_REQUIRED             : constant UInt8 := 16#02#;
   KEYPRESS_NOTIFY_NOT_SUPPORTED   : constant UInt8 := 16#00#;
   KEYPRESS_NOTIFY_SUPPORTED       : constant UInt8 := 16#01#;
   IDENTITY_ADDR_PUBLIC            : constant UInt8 := 16#00#;
   IDENTITY_ADDR_RANDOM            : constant UInt8 := 16#01#;
