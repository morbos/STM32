...
with IIS2MDC_I2C;      use IIS2MDC_I2C;
...
procedure Test_S is
   ...
   is
      ...
      IIS2MDC_Clock_Speed  : constant := 400_000;
   ...
   begin
      ...
      STM32.I2C.Configure
        (Port.all,
         (Clock_Speed              => IIS2MDC_Clock_Speed,
   ...
   IIS2         : IIS2MDC_Sensor  (IIS2MDC_Port'Access);
...
--   Cache_Enable; If enabled.... device_id fails... hmmm
   Initialize_GPIO (Port  => IIS2MDC_I2C_Port,
                    SCL   => IIS2MDC_I2C_Clock_Pin,
                    SDA   => IIS2MDC_I2C_Data_Pin,
                    I2C_AF => IIS2MDC_I2C_Port_AF
                   );
