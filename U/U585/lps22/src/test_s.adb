...
with LPS22HH_I2C;      use LPS22HH_I2C;
...
procedure Test_S is
   ...
   is
      ...
      LPS22HH_Clock_Speed  : constant := 400_000;
   ...
   begin
      ...
      STM32.I2C.Configure
        (Port.all,
         (Clock_Speed              => LPS22HH_Clock_Speed,
   ...
   LPS22         : LPS22HH_Sensor  (LPS22HH_Port'Access);

begin
   Initialize_Board;
   Init_CM33;
--   Cache_Enable; If enabled.... device_id fails... hmmm
   Initialize_GPIO (Port  => LPS22HH_I2C_Port,
                    SCL   => LPS22HH_I2C_Clock_Pin,
                    SDA   => LPS22HH_I2C_Data_Pin,
                    I2C_AF => LPS22HH_I2C_Port_AF
                   );
      LPS22.Configure
