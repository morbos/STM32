...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#e9a5ddb3#;
   ...
   u00023 : constant Version_32 := 16#7e099ed9#;
   ...
   u00120 : constant Version_32 := 16#86ec30d5#;
   pragma Export (C, u00120, "stm32__deviceB");
   u00121 : constant Version_32 := 16#f72fa243#;
   pragma Export (C, u00121, "stm32__deviceS");
   u00122 : constant Version_32 := 16#04878089#;
   pragma Export (C, u00122, "stm32_svdS");
   u00123 : constant Version_32 := 16#d5857c70#;
   pragma Export (C, u00123, "stm32_svd__rccS");
   u00124 : constant Version_32 := 16#497ed1f6#;
   pragma Export (C, u00124, "stm32__adcB");
   u00125 : constant Version_32 := 16#e0ee62e1#;
   pragma Export (C, u00125, "stm32__adcS");
   u00126 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00126, "ada__real_time__delaysB");
   u00127 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00127, "ada__real_time__delaysS");
   u00128 : constant Version_32 := 16#60a802b3#;
   pragma Export (C, u00128, "stm32_svd__adcS");
   u00129 : constant Version_32 := 16#52f1910f#;
   pragma Export (C, u00129, "system__assertionsB");
   u00130 : constant Version_32 := 16#abcb9452#;
   pragma Export (C, u00130, "system__assertionsS");
   u00131 : constant Version_32 := 16#e481624e#;
   pragma Export (C, u00131, "stm32__dacB");
   u00132 : constant Version_32 := 16#a37032eb#;
   pragma Export (C, u00132, "stm32__dacS");
   u00133 : constant Version_32 := 16#5c4b2fb5#;
   pragma Export (C, u00133, "stm32_svd__dacS");
   u00134 : constant Version_32 := 16#b200f2bd#;
   pragma Export (C, u00134, "stm32__dmaB");
   u00135 : constant Version_32 := 16#31a86c73#;
   pragma Export (C, u00135, "stm32__dmaS");
   u00136 : constant Version_32 := 16#c667c1e5#;
   pragma Export (C, u00136, "stm32_svd__dmaS");
   u00137 : constant Version_32 := 16#673f6c65#;
   pragma Export (C, u00137, "stm32__gpioB");
   u00138 : constant Version_32 := 16#3629d892#;
   pragma Export (C, u00138, "stm32__gpioS");
   u00139 : constant Version_32 := 16#77574ecc#;
   pragma Export (C, u00139, "stm32__rccB");
   u00140 : constant Version_32 := 16#738b340d#;
   pragma Export (C, u00140, "stm32__rccS");
   u00141 : constant Version_32 := 16#58c628a1#;
   pragma Export (C, u00141, "stm32__syscfgB");
   u00142 : constant Version_32 := 16#4862cf09#;
   pragma Export (C, u00142, "stm32__syscfgS");
   u00143 : constant Version_32 := 16#0b2850f0#;
   pragma Export (C, u00143, "stm32__extiB");
   u00144 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00144, "stm32__extiS");
   u00145 : constant Version_32 := 16#7269168b#;
   pragma Export (C, u00145, "stm32_svd__extiS");
   u00146 : constant Version_32 := 16#d542fb4d#;
   pragma Export (C, u00146, "stm32_svd__syscfgS");
   u00147 : constant Version_32 := 16#4c5b381f#;
   pragma Export (C, u00147, "stm32_svd__gpioS");
   u00148 : constant Version_32 := 16#10558b11#;
   pragma Export (C, u00148, "ada__streamsB");
   u00149 : constant Version_32 := 16#7705e907#;
   pragma Export (C, u00149, "ada__streamsS");
   u00150 : constant Version_32 := 16#823e79d0#;
   pragma Export (C, u00150, "ada__io_exceptionsS");
   u00151 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00151, "hal__gpioS");
   u00152 : constant Version_32 := 16#77cfbaf2#;
   pragma Export (C, u00152, "system__finalization_mastersB");
   u00153 : constant Version_32 := 16#3dba810c#;
   ...
   u00155 : constant Version_32 := 16#939fc92d#;
   pragma Export (C, u00155, "system__img_boolS");
   u00156 : constant Version_32 := 16#9623954f#;
   ...
   u00158 : constant Version_32 := 16#29b4cb56#;
   ...
   u00160 : constant Version_32 := 16#45ab266b#;
   pragma Export (C, u00160, "system__storage_poolsS");
   u00161 : constant Version_32 := 16#5a895de2#;
   pragma Export (C, u00161, "system__pool_globalB");
   u00162 : constant Version_32 := 16#7141203e#;
   pragma Export (C, u00162, "system__pool_globalS");
   u00163 : constant Version_32 := 16#a66a0087#;
   pragma Export (C, u00163, "system__memoryB");
   u00164 : constant Version_32 := 16#3f3bdef2#;
   ...
   u00170 : constant Version_32 := 16#25c608b5#;
   ...
   u00173 : constant Version_32 := 16#97d41435#;
   ...
   u00176 : constant Version_32 := 16#3ade4712#;
   ...
   u00179 : constant Version_32 := 16#e86f38e3#;
   pragma Export (C, u00179, "vl6180x_i2cB");
   u00180 : constant Version_32 := 16#3d21dfc8#;
   pragma Export (C, u00180, "vl6180x_i2cS");
   u00181 : constant Version_32 := 16#ab0d7f29#;
   pragma Export (C, u00181, "vl6180xB");
   u00182 : constant Version_32 := 16#90a49df7#;
   pragma Export (C, u00182, "vl6180xS");
   u00183 : constant Version_32 := 16#e75d7e95#;
   pragma Export (C, u00183, "vl6180x_i2c_ioB");
   u00184 : constant Version_32 := 16#2d7bf322#;
   pragma Export (C, u00184, "vl6180x_i2c_ioS");
   u00185 : constant Version_32 := 16#355ab59c#;
   pragma Export (C, u00185, "system__img_enum_newB");
   u00186 : constant Version_32 := 16#070abe06#;
