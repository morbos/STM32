...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_timer_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4d9dd27f#;
   pragma Export (C, u00001, "timer_f103B");
   ...
   u00064 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00064, "stm32S");
   u00065 : constant Version_32 := 16#71f79a66#;
   pragma Export (C, u00065, "halS");
   u00066 : constant Version_32 := 16#ab5f03f3#;
   pragma Export (C, u00066, "stm32__boardB");
   u00067 : constant Version_32 := 16#7398dfbc#;
   pragma Export (C, u00067, "stm32__boardS");
   u00068 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00068, "stm32__setupS");
   u00069 : constant Version_32 := 16#1fd5c97f#;
   pragma Export (C, u00069, "stm32__gpioB");
   u00070 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00070, "stm32__gpioS");
   u00071 : constant Version_32 := 16#a71f2a10#;
   pragma Export (C, u00071, "stm32__rccB");
   u00072 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00072, "stm32__rccS");
   u00073 : constant Version_32 := 16#61404bc6#;
   pragma Export (C, u00073, "stm32__deviceB");
   u00074 : constant Version_32 := 16#4d6a6d13#;
   pragma Export (C, u00074, "stm32__deviceS");
   u00075 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00075, "stm32_svdS");
   u00076 : constant Version_32 := 16#78b98332#;
   ...
   u00079 : constant Version_32 := 16#269d2c81#;
   pragma Export (C, u00079, "stm32__adcB");
   u00080 : constant Version_32 := 16#e6605efc#;
   pragma Export (C, u00080, "stm32__adcS");
   u00081 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00081, "ada__real_time__delaysB");
   u00082 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00082, "ada__real_time__delaysS");
   u00083 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00083, "stm32_svd__adcS");
   u00084 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00084, "stm32__crcB");
   u00085 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00085, "stm32__crcS");
   u00086 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00086, "stm32_svd__crcS");
   u00087 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00087, "stm32__dacB");
   u00088 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00088, "stm32__dacS");
   u00089 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00089, "stm32_svd__dacS");
   u00090 : constant Version_32 := 16#ab9529ed#;
   pragma Export (C, u00090, "stm32__dmaB");
   u00091 : constant Version_32 := 16#36fadff1#;
   pragma Export (C, u00091, "stm32__dmaS");
   u00092 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00092, "stm32_svd__dmaS");
   u00093 : constant Version_32 := 16#2a35a0a9#;
   pragma Export (C, u00093, "stm32__i2cB");
   u00094 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00094, "stm32__i2cS");
   u00095 : constant Version_32 := 16#cde18a7d#;
   pragma Export (C, u00095, "stm32_svd__i2cS");
   u00096 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00096, "system__img_unsB");
   u00097 : constant Version_32 := 16#a09f88a5#;
   pragma Export (C, u00097, "system__img_unsS");
   u00098 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00098, "hal__i2cS");
   u00099 : constant Version_32 := 16#cc2a548f#;
   pragma Export (C, u00099, "stm32__i2sB");
   u00100 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00100, "stm32__i2sS");
   u00101 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00101, "hal__audioS");
   u00102 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00102, "stm32_svd__spiS");
   u00103 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00103, "stm32__rtcS");
   u00104 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00104, "hal__real_time_clockS");
   u00105 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00105, "stm32__spiB");
   u00106 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00106, "stm32__spiS");
   u00107 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00107, "hal__spiS");
   u00108 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00108, "stm32__timersB");
   u00109 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00109, "stm32__timersS");
   u00110 : constant Version_32 := 16#af403693#;
   pragma Export (C, u00110, "stm32__usartsB");
   u00111 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00111, "stm32__usartsS");
   u00112 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00112, "stm32_svd__usartS");
   u00113 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00113, "hal__uartS");
   u00114 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00114, "stm32_svd__pwrS");
   u00115 : constant Version_32 := 16#ff4dd5b4#;
   pragma Export (C, u00115, "stm32__syscfgS");
   u00116 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00116, "stm32_svd__afioS");
   u00117 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00117, "stm32_svd__gpioS");
   u00118 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00118, "hal__gpioS");
   u00119 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00119, "stm32__extiB");
   u00120 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00120, "stm32__extiS");
   u00121 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00121, "stm32_svd__extiS");
   u00122 : constant Version_32 := 16#193628c0#;
   pragma Export (C, u00122, "stm32f1_timer_interruptsB");
   u00123 : constant Version_32 := 16#5d0e03f7#;
   pragma Export (C, u00123, "stm32f1_timer_interruptsS");
   u00124 : constant Version_32 := 16#86882935#;
   pragma Export (C, u00124, "system__tasking__protected_objectsB");
   u00125 : constant Version_32 := 16#7670502d#;
   ...
   u00129 : constant Version_32 := 16#2232cf53#;
   pragma Export (C, u00129, "ada__task_identificationS");
   u00130 : constant Version_32 := 16#858ee8bc#;
   pragma Export (C, u00130, "system__tasking__restrictedS");
   u00131 : constant Version_32 := 16#c4977486#;
   ...
   u00134 : constant Version_32 := 16#38e9971b#;
   pragma Export (C, u00134, "system__interruptsS");
   u00135 : constant Version_32 := 16#1ab029f2#;
   pragma Export (C, u00135, "system__tasking__protected_objects__single_entryB");
   u00136 : constant Version_32 := 16#c7328e25#;
   pragma Export (C, u00136, "system__tasking__protected_objects__single_entryS");
   u00137 : constant Version_32 := 16#1ff5c9d4#;
   pragma Export (C, u00137, "system__tasking__protected_objects__multiprocessorsB");
   u00138 : constant Version_32 := 16#01c3fc38#;
   pragma Export (C, u00138, "system__tasking__protected_objects__multiprocessorsS");
   u00139 : constant Version_32 := 16#62535264#;
   pragma Export (C, u00139, "ada__interrupts__namesS");
   ...
   --  stm32.board%s
   --  stm32.board%b
   --  stm32f1_timer_interrupts%s
   --  stm32f1_timer_interrupts%b
   --  timer_f103%b
