...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#3c8f056a#;
   ...
   u00011 : constant Version_32 := 16#e6c66bf2#;
   ...
   u00021 : constant Version_32 := 16#cbc46683#;
   ...
   u00025 : constant Version_32 := 16#b59dcfef#;
   ...
   u00028 : constant Version_32 := 16#ff98ed9d#;
   ...
   u00030 : constant Version_32 := 16#79e26bc6#;
   ...
   u00037 : constant Version_32 := 16#4e87ff8a#;
   pragma Export (C, u00037, "system__multiprocessorsS");
   u00038 : constant Version_32 := 16#570a3df2#;
   ...
   u00047 : constant Version_32 := 16#bd1a50a1#;
   pragma Export (C, u00047, "system__bb__interruptsS");
   u00048 : constant Version_32 := 16#3f18cf6e#;
   ...
   u00066 : constant Version_32 := 16#67c984e6#;
   ...
   u00070 : constant Version_32 := 16#aaa800a5#;
   pragma Export (C, u00070, "fontsB");
   u00071 : constant Version_32 := 16#e70a6253#;
   pragma Export (C, u00071, "fontsS");
   u00072 : constant Version_32 := 16#1814bdbb#;
   pragma Export (C, u00072, "fonts__font2S");
   u00073 : constant Version_32 := 16#71f79a66#;
   pragma Export (C, u00073, "halS");
   u00074 : constant Version_32 := 16#9b05534e#;
   pragma Export (C, u00074, "ssd1306_spiB");
   u00075 : constant Version_32 := 16#73a715a4#;
   pragma Export (C, u00075, "ssd1306_spiS");
   u00076 : constant Version_32 := 16#2344c190#;
   pragma Export (C, u00076, "hal__bitmapS");
   u00077 : constant Version_32 := 16#b0b8b049#;
   pragma Export (C, u00077, "hal__framebufferS");
   u00078 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00078, "hal__gpioS");
   u00079 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00079, "hal__spiS");
   u00080 : constant Version_32 := 16#de6b94d9#;
   pragma Export (C, u00080, "hal__timeS");
   u00081 : constant Version_32 := 16#dadb12ca#;
   pragma Export (C, u00081, "memory_mapped_bitmapB");
   u00082 : constant Version_32 := 16#d57dec84#;
   pragma Export (C, u00082, "memory_mapped_bitmapS");
   u00083 : constant Version_32 := 16#07016f71#;
   pragma Export (C, u00083, "bitmap_color_conversionB");
   u00084 : constant Version_32 := 16#566ee026#;
   pragma Export (C, u00084, "bitmap_color_conversionS");
   u00085 : constant Version_32 := 16#eae50723#;
   pragma Export (C, u00085, "soft_drawing_bitmapB");
   u00086 : constant Version_32 := 16#697d739d#;
   pragma Export (C, u00086, "soft_drawing_bitmapS");
   u00087 : constant Version_32 := 16#748adc27#;
   pragma Export (C, u00087, "system__assertionsB");
   u00088 : constant Version_32 := 16#c660e445#;
   pragma Export (C, u00088, "system__assertionsS");
   u00089 : constant Version_32 := 16#189dd11d#;
   pragma Export (C, u00089, "last_chance_handlerB");
   u00090 : constant Version_32 := 16#d1bc38d5#;
   pragma Export (C, u00090, "last_chance_handlerS");
   u00091 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00091, "ada__real_time__delaysB");
   u00092 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00092, "ada__real_time__delaysS");
   ...
   u00095 : constant Version_32 := 16#7398dfbc#;
   pragma Export (C, u00095, "stm32__boardS");
   u00096 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00096, "stm32__setupS");
   u00097 : constant Version_32 := 16#089896ae#;
   pragma Export (C, u00097, "stm32__gpioB");
   u00098 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00098, "stm32__gpioS");
   u00099 : constant Version_32 := 16#bcd3cae4#;
   pragma Export (C, u00099, "stm32__afioB");
   u00100 : constant Version_32 := 16#1de8076d#;
   pragma Export (C, u00100, "stm32__afioS");
   u00101 : constant Version_32 := 16#5a73acc1#;
   pragma Export (C, u00101, "stm32__deviceB");
   u00102 : constant Version_32 := 16#20e562e2#;
   ...
   u00117 : constant Version_32 := 16#29beb20a#;
   ...
   u00123 : constant Version_32 := 16#cc2a548f#;
   ...
   u00133 : constant Version_32 := 16#af403693#;
   ...
   u00137 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00137, "stm32__extiB");
   u00138 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00138, "stm32__extiS");
   u00139 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00139, "stm32_svd__extiS");
   u00140 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00140, "stm32_svd__afioS");
   u00141 : constant Version_32 := 16#a71f2a10#;
   pragma Export (C, u00141, "stm32__rccB");
   u00142 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00142, "stm32__rccS");
   u00143 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00143, "stm32_svd__pwrS");
   u00144 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00144, "stm32_svd__gpioS");
   u00145 : constant Version_32 := 16#3dc7fe45#;
   pragma Export (C, u00145, "peripheralsS");
   u00146 : constant Version_32 := 16#153ecc5d#;
   pragma Export (C, u00146, "ravenscar_timeB");
   u00147 : constant Version_32 := 16#8f0ab111#;
   pragma Export (C, u00147, "ravenscar_timeS");
