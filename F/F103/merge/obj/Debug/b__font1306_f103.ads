...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_font1306_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#45b6efb8#;
   pragma Export (C, u00001, "font1306_f103B");
   ...
   u00066 : constant Version_32 := 16#d3a2eabd#;
   pragma Export (C, u00066, "ada__text_ioB");
   u00067 : constant Version_32 := 16#99562386#;
   pragma Export (C, u00067, "ada__text_ioS");
   u00068 : constant Version_32 := 16#5cfa63e1#;
   pragma Export (C, u00068, "system__text_ioB");
   u00069 : constant Version_32 := 16#7edf9820#;
   pragma Export (C, u00069, "system__text_ioS");
   u00070 : constant Version_32 := 16#54f3ef79#;
   pragma Export (C, u00070, "interfaces__stm32__gpioS");
   u00071 : constant Version_32 := 16#d6f238fc#;
   pragma Export (C, u00071, "interfaces__stm32__usartS");
   u00072 : constant Version_32 := 16#aaa800a5#;
   pragma Export (C, u00072, "fontsB");
   u00073 : constant Version_32 := 16#e70a6253#;
   pragma Export (C, u00073, "fontsS");
   u00074 : constant Version_32 := 16#1814bdbb#;
   pragma Export (C, u00074, "fonts__font2S");
   u00075 : constant Version_32 := 16#71f79a66#;
   pragma Export (C, u00075, "halS");
   u00076 : constant Version_32 := 16#9b05534e#;
   pragma Export (C, u00076, "ssd1306_spiB");
   u00077 : constant Version_32 := 16#73a715a4#;
   pragma Export (C, u00077, "ssd1306_spiS");
   u00078 : constant Version_32 := 16#2344c190#;
   pragma Export (C, u00078, "hal__bitmapS");
   u00079 : constant Version_32 := 16#b0b8b049#;
   pragma Export (C, u00079, "hal__framebufferS");
   u00080 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00080, "hal__gpioS");
   u00081 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00081, "hal__spiS");
   u00082 : constant Version_32 := 16#de6b94d9#;
   pragma Export (C, u00082, "hal__timeS");
   u00083 : constant Version_32 := 16#dadb12ca#;
   pragma Export (C, u00083, "memory_mapped_bitmapB");
   u00084 : constant Version_32 := 16#d57dec84#;
   pragma Export (C, u00084, "memory_mapped_bitmapS");
   u00085 : constant Version_32 := 16#07016f71#;
   pragma Export (C, u00085, "bitmap_color_conversionB");
   u00086 : constant Version_32 := 16#566ee026#;
   pragma Export (C, u00086, "bitmap_color_conversionS");
   u00087 : constant Version_32 := 16#eae50723#;
   pragma Export (C, u00087, "soft_drawing_bitmapB");
   u00088 : constant Version_32 := 16#697d739d#;
   pragma Export (C, u00088, "soft_drawing_bitmapS");
   u00089 : constant Version_32 := 16#748adc27#;
   pragma Export (C, u00089, "system__assertionsB");
   u00090 : constant Version_32 := 16#c660e445#;
   pragma Export (C, u00090, "system__assertionsS");
   u00091 : constant Version_32 := 16#189dd11d#;
   pragma Export (C, u00091, "last_chance_handlerB");
   u00092 : constant Version_32 := 16#d1bc38d5#;
   pragma Export (C, u00092, "last_chance_handlerS");
   u00093 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00093, "stm32S");
   u00094 : constant Version_32 := 16#ab5f03f3#;
   pragma Export (C, u00094, "stm32__boardB");
   u00095 : constant Version_32 := 16#9826467f#;
   pragma Export (C, u00095, "stm32__boardS");
   u00096 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00096, "stm32__setupS");
   u00097 : constant Version_32 := 16#1fd5c97f#;
   pragma Export (C, u00097, "stm32__gpioB");
   u00098 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00098, "stm32__gpioS");
   u00099 : constant Version_32 := 16#4ca1b3d3#;
   pragma Export (C, u00099, "stm32__rccB");
   u00100 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00100, "stm32__rccS");
   u00101 : constant Version_32 := 16#59ea569b#;
   pragma Export (C, u00101, "stm32__deviceB");
   u00102 : constant Version_32 := 16#cb5bfb21#;
   pragma Export (C, u00102, "stm32__deviceS");
   u00103 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00103, "stm32_svdS");
   u00104 : constant Version_32 := 16#78b98332#;
   pragma Export (C, u00104, "stm32_svd__rccS");
   u00105 : constant Version_32 := 16#269d2c81#;
   pragma Export (C, u00105, "stm32__adcB");
   u00106 : constant Version_32 := 16#e6605efc#;
   pragma Export (C, u00106, "stm32__adcS");
   u00107 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00107, "stm32_svd__adcS");
   u00108 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00108, "stm32__crcB");
   u00109 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00109, "stm32__crcS");
   u00110 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00110, "stm32_svd__crcS");
   u00111 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00111, "stm32__dacB");
   u00112 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00112, "stm32__dacS");
   u00113 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00113, "stm32_svd__dacS");
   u00114 : constant Version_32 := 16#817a1cff#;
   pragma Export (C, u00114, "stm32__dmaB");
   u00115 : constant Version_32 := 16#5b75d000#;
   pragma Export (C, u00115, "stm32__dmaS");
   u00116 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00116, "stm32_svd__dmaS");
   u00117 : constant Version_32 := 16#c2002bc9#;
   pragma Export (C, u00117, "stm32__i2cB");
   u00118 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00118, "stm32__i2cS");
   u00119 : constant Version_32 := 16#cde18a7d#;
   pragma Export (C, u00119, "stm32_svd__i2cS");
   u00120 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00120, "system__img_unsB");
   u00121 : constant Version_32 := 16#a09f88a5#;
   pragma Export (C, u00121, "system__img_unsS");
   u00122 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00122, "hal__i2cS");
   u00123 : constant Version_32 := 16#2794cd4c#;
   pragma Export (C, u00123, "stm32__i2sB");
   u00124 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00124, "stm32__i2sS");
   u00125 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00125, "hal__audioS");
   u00126 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00126, "stm32_svd__spiS");
   u00127 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00127, "stm32__rtcS");
   u00128 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00128, "hal__real_time_clockS");
   u00129 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00129, "stm32__spiB");
   u00130 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00130, "stm32__spiS");
   u00131 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00131, "stm32__timersB");
   u00132 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00132, "stm32__timersS");
   u00133 : constant Version_32 := 16#44feaf50#;
   pragma Export (C, u00133, "stm32__usartsB");
   u00134 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00134, "stm32__usartsS");
   u00135 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00135, "stm32_svd__usartS");
   u00136 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00136, "hal__uartS");
   u00137 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00137, "stm32_svd__pwrS");
   u00138 : constant Version_32 := 16#ff4dd5b4#;
   pragma Export (C, u00138, "stm32__syscfgS");
   u00139 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00139, "stm32_svd__afioS");
   u00140 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00140, "stm32_svd__gpioS");
   u00141 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00141, "stm32__extiB");
   u00142 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00142, "stm32__extiS");
   u00143 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00143, "stm32_svd__extiS");
   u00144 : constant Version_32 := 16#0073c8a7#;
   pragma Export (C, u00144, "peripheralsS");
   u00145 : constant Version_32 := 16#153ecc5d#;
   pragma Export (C, u00145, "ravenscar_timeB");
   u00146 : constant Version_32 := 16#8f0ab111#;
   pragma Export (C, u00146, "ravenscar_timeS");
   u00147 : constant Version_32 := 16#b0c20809#;
   pragma Export (C, u00147, "traceB");
   u00148 : constant Version_32 := 16#b27a122a#;
   pragma Export (C, u00148, "traceS");
   u00149 : constant Version_32 := 16#e8b5ddbd#;
   pragma Export (C, u00149, "cortex_m_svdS");
   u00150 : constant Version_32 := 16#e4734a8d#;
   pragma Export (C, u00150, "cortex_m_svd__debugS");
   u00151 : constant Version_32 := 16#c4791250#;
   pragma Export (C, u00151, "cortex_m_svd__dwtS");
   u00152 : constant Version_32 := 16#a863beb9#;
   pragma Export (C, u00152, "stm32_svd__dbgS");
   u00153 : constant Version_32 := 16#93b2595c#;
   pragma Export (C, u00153, "vl53l1xB");
   u00154 : constant Version_32 := 16#1be8a840#;
   pragma Export (C, u00154, "vl53l1xS");
