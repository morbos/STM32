...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ssd1306_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#fd1d08d1#;
   pragma Export (C, u00001, "ssd1306_f103B");
   ...
   u00071 : constant Version_32 := 16#2344c190#;
   pragma Export (C, u00071, "hal__bitmapS");
   u00072 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00072, "hal__spiS");
   ...
   u00075 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00075, "ada__real_time__delaysB");
   u00076 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00076, "ada__real_time__delaysS");
   u00077 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00077, "stm32S");
   u00078 : constant Version_32 := 16#ab5f03f3#;
   pragma Export (C, u00078, "stm32__boardB");
   u00079 : constant Version_32 := 16#9826467f#;
   pragma Export (C, u00079, "stm32__boardS");
   u00080 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00080, "stm32__setupS");
   u00081 : constant Version_32 := 16#1fd5c97f#;
   pragma Export (C, u00081, "stm32__gpioB");
   u00082 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00082, "stm32__gpioS");
   u00083 : constant Version_32 := 16#4ca1b3d3#;
   pragma Export (C, u00083, "stm32__rccB");
   u00084 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00084, "stm32__rccS");
   u00085 : constant Version_32 := 16#59ea569b#;
   pragma Export (C, u00085, "stm32__deviceB");
   u00086 : constant Version_32 := 16#cb5bfb21#;
   pragma Export (C, u00086, "stm32__deviceS");
   u00087 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00087, "stm32_svdS");
   u00088 : constant Version_32 := 16#78b98332#;
   pragma Export (C, u00088, "stm32_svd__rccS");
   ...
   u00091 : constant Version_32 := 16#269d2c81#;
   pragma Export (C, u00091, "stm32__adcB");
   u00092 : constant Version_32 := 16#e6605efc#;
   pragma Export (C, u00092, "stm32__adcS");
   u00093 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00093, "stm32_svd__adcS");
   u00094 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00094, "stm32__crcB");
   u00095 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00095, "stm32__crcS");
   u00096 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00096, "stm32_svd__crcS");
   u00097 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00097, "stm32__dacB");
   u00098 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00098, "stm32__dacS");
   u00099 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00099, "stm32_svd__dacS");
   u00100 : constant Version_32 := 16#817a1cff#;
   pragma Export (C, u00100, "stm32__dmaB");
   u00101 : constant Version_32 := 16#5b75d000#;
   pragma Export (C, u00101, "stm32__dmaS");
   u00102 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00102, "stm32_svd__dmaS");
   u00103 : constant Version_32 := 16#c2002bc9#;
   pragma Export (C, u00103, "stm32__i2cB");
   u00104 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00104, "stm32__i2cS");
   u00105 : constant Version_32 := 16#cde18a7d#;
   pragma Export (C, u00105, "stm32_svd__i2cS");
   u00106 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00106, "system__img_unsB");
   u00107 : constant Version_32 := 16#a09f88a5#;
   pragma Export (C, u00107, "system__img_unsS");
   u00108 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00108, "hal__i2cS");
   u00109 : constant Version_32 := 16#2794cd4c#;
   pragma Export (C, u00109, "stm32__i2sB");
   u00110 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00110, "stm32__i2sS");
   u00111 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00111, "hal__audioS");
   u00112 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00112, "stm32_svd__spiS");
   u00113 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00113, "stm32__rtcS");
   u00114 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00114, "hal__real_time_clockS");
   u00115 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00115, "stm32__spiB");
   u00116 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00116, "stm32__spiS");
   u00117 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00117, "stm32__timersB");
   u00118 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00118, "stm32__timersS");
   u00119 : constant Version_32 := 16#44feaf50#;
   pragma Export (C, u00119, "stm32__usartsB");
   u00120 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00120, "stm32__usartsS");
   u00121 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00121, "stm32_svd__usartS");
   u00122 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00122, "hal__uartS");
   u00123 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00123, "stm32_svd__pwrS");
   u00124 : constant Version_32 := 16#ff4dd5b4#;
   pragma Export (C, u00124, "stm32__syscfgS");
   u00125 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00125, "stm32_svd__afioS");
   u00126 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00126, "stm32_svd__gpioS");
   u00127 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00127, "hal__gpioS");
   u00128 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00128, "stm32__extiB");
   u00129 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00129, "stm32__extiS");
   u00130 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00130, "stm32_svd__extiS");
   u00131 : constant Version_32 := 16#d6796786#;
   pragma Export (C, u00131, "peripheralsS");
   u00132 : constant Version_32 := 16#153ecc5d#;
   pragma Export (C, u00132, "ravenscar_timeB");
   u00133 : constant Version_32 := 16#8f0ab111#;
   pragma Export (C, u00133, "ravenscar_timeS");
   u00134 : constant Version_32 := 16#de6b94d9#;
   pragma Export (C, u00134, "hal__timeS");
   u00135 : constant Version_32 := 16#cabd9d1b#;
   pragma Export (C, u00135, "ssd1306_spiB");
   u00136 : constant Version_32 := 16#a34cefb5#;
   pragma Export (C, u00136, "ssd1306_spiS");
   u00137 : constant Version_32 := 16#b0b8b049#;
   pragma Export (C, u00137, "hal__framebufferS");
   u00138 : constant Version_32 := 16#dadb12ca#;
   pragma Export (C, u00138, "memory_mapped_bitmapB");
   u00139 : constant Version_32 := 16#d57dec84#;
   pragma Export (C, u00139, "memory_mapped_bitmapS");
   u00140 : constant Version_32 := 16#07016f71#;
   pragma Export (C, u00140, "bitmap_color_conversionB");
   u00141 : constant Version_32 := 16#566ee026#;
   pragma Export (C, u00141, "bitmap_color_conversionS");
   u00142 : constant Version_32 := 16#eae50723#;
   pragma Export (C, u00142, "soft_drawing_bitmapB");
   u00143 : constant Version_32 := 16#697d739d#;
   pragma Export (C, u00143, "soft_drawing_bitmapS");
