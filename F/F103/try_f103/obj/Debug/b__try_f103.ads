...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#ba46fefe#;
   pragma Export (C, u00001, "try_f103B");
   ...
   u00011 : constant Version_32 := 16#323b9257#;
   ...
   u00017 : constant Version_32 := 16#951f8e3f#;
   ...
   u00073 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00073, "stm32S");
   u00074 : constant Version_32 := 16#4e30778c#;
   pragma Export (C, u00074, "stm32__boardB");
   u00075 : constant Version_32 := 16#a5a926f5#;
   pragma Export (C, u00075, "stm32__boardS");
   u00076 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00076, "stm32__setupS");
   u00077 : constant Version_32 := 16#e9f61b61#;
   pragma Export (C, u00077, "stm32__gpioB");
   u00078 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00078, "stm32__gpioS");
   u00079 : constant Version_32 := 16#ca40e4a8#;
   pragma Export (C, u00079, "stm32__rccB");
   u00080 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00080, "stm32__rccS");
   u00081 : constant Version_32 := 16#76d13191#;
   pragma Export (C, u00081, "stm32__deviceB");
   u00082 : constant Version_32 := 16#2b44f4c7#;
   pragma Export (C, u00082, "stm32__deviceS");
   u00083 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00083, "stm32_svdS");
   u00084 : constant Version_32 := 16#78b98332#;
   pragma Export (C, u00084, "stm32_svd__rccS");
   u00085 : constant Version_32 := 16#748adc27#;
   pragma Export (C, u00085, "system__assertionsB");
   u00086 : constant Version_32 := 16#c660e445#;
   pragma Export (C, u00086, "system__assertionsS");
   u00087 : constant Version_32 := 16#d9537107#;
   pragma Export (C, u00087, "stm32__adcS");
   u00088 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00088, "stm32_svd__adcS");
   u00089 : constant Version_32 := 16#fadb5ea9#;
   pragma Export (C, u00089, "stm32__crcB");
   u00090 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00090, "stm32__crcS");
   u00091 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00091, "stm32_svd__crcS");
   u00092 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00092, "stm32__dacB");
   u00093 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00093, "stm32__dacS");
   u00094 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00094, "stm32_svd__dacS");
   u00095 : constant Version_32 := 16#02b8a766#;
   pragma Export (C, u00095, "stm32__dmaS");
   u00096 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00096, "stm32_svd__dmaS");
   u00097 : constant Version_32 := 16#476a6e11#;
   pragma Export (C, u00097, "stm32__i2cB");
   u00098 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00098, "stm32__i2cS");
   u00099 : constant Version_32 := 16#cde18a7d#;
   pragma Export (C, u00099, "stm32_svd__i2cS");
   u00100 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00100, "system__img_unsB");
   u00101 : constant Version_32 := 16#a09f88a5#;
   pragma Export (C, u00101, "system__img_unsS");
   u00102 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00102, "hal__i2cS");
   u00103 : constant Version_32 := 16#a1759a37#;
   pragma Export (C, u00103, "stm32__i2sB");
   u00104 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00104, "stm32__i2sS");
   u00105 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00105, "hal__audioS");
   u00106 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00106, "stm32_svd__spiS");
   u00107 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00107, "stm32__rtcS");
   u00108 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00108, "hal__real_time_clockS");
   u00109 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00109, "stm32__spiB");
   u00110 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00110, "stm32__spiS");
   u00111 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00111, "hal__spiS");
   u00112 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00112, "stm32__timersB");
   u00113 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00113, "stm32__timersS");
   u00114 : constant Version_32 := 16#c21ff82b#;
   pragma Export (C, u00114, "stm32__usartsB");
   u00115 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00115, "stm32__usartsS");
   u00116 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00116, "stm32_svd__usartS");
   u00117 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00117, "hal__uartS");
   u00118 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00118, "stm32_svd__pwrS");
   u00119 : constant Version_32 := 16#ff4dd5b4#;
   pragma Export (C, u00119, "stm32__syscfgS");
   u00120 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00120, "stm32_svd__afioS");
   u00121 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00121, "stm32_svd__gpioS");
   u00122 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00122, "hal__gpioS");
   u00123 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00123, "stm32__extiB");
   u00124 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00124, "stm32__extiS");
   u00125 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00125, "stm32_svd__extiS");
