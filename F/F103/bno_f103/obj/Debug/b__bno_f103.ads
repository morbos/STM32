...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_bno_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9e872e3e#;
   pragma Export (C, u00001, "bno_f103B");
   ...
   u00004 : constant Version_32 := 16#5e68f5cc#;
   pragma Export (C, u00004, "ada__exceptionsB");
   u00005 : constant Version_32 := 16#362ca14a#;
   pragma Export (C, u00005, "ada__exceptionsS");
   u00006 : constant Version_32 := 16#500583ea#;
   pragma Export (C, u00006, "ada__real_timeB");
   u00007 : constant Version_32 := 16#786da119#;
   ...
   u00009 : constant Version_32 := 16#55801c0d#;
   pragma Export (C, u00009, "system__os_interfaceS");
   u00010 : constant Version_32 := 16#bf33852c#;
   pragma Export (C, u00010, "system__bbS");
   u00011 : constant Version_32 := 16#5a8c3df4#;
   ...
   u00072 : constant Version_32 := 16#4fcff3f0#;
   pragma Export (C, u00072, "bno055_i2cB");
   u00073 : constant Version_32 := 16#29da3108#;
   pragma Export (C, u00073, "bno055_i2cS");
   u00074 : constant Version_32 := 16#437b2964#;
   pragma Export (C, u00074, "bno055_i2c_ioB");
   u00075 : constant Version_32 := 16#7212972a#;
   pragma Export (C, u00075, "bno055_i2c_ioS");
   u00076 : constant Version_32 := 16#9dca6636#;
   pragma Export (C, u00076, "system__img_lliB");
   u00077 : constant Version_32 := 16#1aa29d00#;
   pragma Export (C, u00077, "system__img_lliS");
   u00078 : constant Version_32 := 16#71f79a66#;
   pragma Export (C, u00078, "halS");
   u00079 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00079, "hal__i2cS");
   u00080 : constant Version_32 := 16#3b4618b1#;
   pragma Export (C, u00080, "bosch_bno055B");
   u00081 : constant Version_32 := 16#51b4c4cd#;
   pragma Export (C, u00081, "bosch_bno055S");
   u00082 : constant Version_32 := 16#2500fbb1#;
   pragma Export (C, u00082, "delay_millisecondsB");
   u00083 : constant Version_32 := 16#1a3c3a9e#;
   pragma Export (C, u00083, "delay_millisecondsS");
   u00084 : constant Version_32 := 16#748adc27#;
   pragma Export (C, u00084, "system__assertionsB");
   u00085 : constant Version_32 := 16#c660e445#;
   pragma Export (C, u00085, "system__assertionsS");
   u00086 : constant Version_32 := 16#e15405b0#;
   pragma Export (C, u00086, "last_chance_handlerB");
   u00087 : constant Version_32 := 16#d1bc38d5#;
   pragma Export (C, u00087, "last_chance_handlerS");
   u00088 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00088, "stm32S");
   u00089 : constant Version_32 := 16#e3f34e1b#;
   pragma Export (C, u00089, "stm32__boardB");
   u00090 : constant Version_32 := 16#d9b13ae4#;
   pragma Export (C, u00090, "stm32__boardS");
   u00091 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00091, "stm32__setupS");
   u00092 : constant Version_32 := 16#c7dd6143#;
   pragma Export (C, u00092, "stm32__gpioB");
   u00093 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00093, "stm32__gpioS");
   u00094 : constant Version_32 := 16#459a82a0#;
   pragma Export (C, u00094, "stm32__rccB");
   u00095 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00095, "stm32__rccS");
   u00096 : constant Version_32 := 16#233acc41#;
   pragma Export (C, u00096, "stm32__deviceB");
   u00097 : constant Version_32 := 16#0b1276d1#;
   pragma Export (C, u00097, "stm32__deviceS");
   u00098 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00098, "stm32_svdS");
   u00099 : constant Version_32 := 16#78b98332#;
   pragma Export (C, u00099, "stm32_svd__rccS");
   u00100 : constant Version_32 := 16#55dfbaa6#;
   pragma Export (C, u00100, "stm32__adcB");
   u00101 : constant Version_32 := 16#0316ffbb#;
   pragma Export (C, u00101, "stm32__adcS");
   u00102 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00102, "stm32_svd__adcS");
   u00103 : constant Version_32 := 16#fadb5ea9#;
   pragma Export (C, u00103, "stm32__crcB");
   u00104 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00104, "stm32__crcS");
   u00105 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00105, "stm32_svd__crcS");
   u00106 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00106, "stm32__dacB");
   u00107 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00107, "stm32__dacS");
   u00108 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00108, "stm32_svd__dacS");
   u00109 : constant Version_32 := 16#fdbad275#;
   pragma Export (C, u00109, "stm32__dmaB");
   u00110 : constant Version_32 := 16#7771cdc4#;
   pragma Export (C, u00110, "stm32__dmaS");
   u00111 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00111, "stm32_svd__dmaS");
   u00112 : constant Version_32 := 16#c8b00819#;
   pragma Export (C, u00112, "stm32__i2cB");
   u00113 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00113, "stm32__i2cS");
   u00114 : constant Version_32 := 16#cde18a7d#;
   pragma Export (C, u00114, "stm32_svd__i2cS");
   u00115 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00115, "system__img_unsB");
   u00116 : constant Version_32 := 16#a09f88a5#;
   pragma Export (C, u00116, "system__img_unsS");
   u00117 : constant Version_32 := 16#2eaffc3f#;
   pragma Export (C, u00117, "stm32__i2sB");
   u00118 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00118, "stm32__i2sS");
   u00119 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00119, "hal__audioS");
   u00120 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00120, "stm32_svd__spiS");
   u00121 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00121, "stm32__rtcS");
   u00122 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00122, "hal__real_time_clockS");
   u00123 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00123, "stm32__spiB");
   u00124 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00124, "stm32__spiS");
   u00125 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00125, "hal__spiS");
   u00126 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00126, "stm32__timersB");
   u00127 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00127, "stm32__timersS");
   u00128 : constant Version_32 := 16#4dc59e23#;
   pragma Export (C, u00128, "stm32__usartsB");
   u00129 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00129, "stm32__usartsS");
   u00130 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00130, "stm32_svd__usartS");
   u00131 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00131, "hal__uartS");
   u00132 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00132, "stm32_svd__pwrS");
   u00133 : constant Version_32 := 16#ff4dd5b4#;
   pragma Export (C, u00133, "stm32__syscfgS");
   u00134 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00134, "stm32_svd__afioS");
   u00135 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00135, "stm32_svd__gpioS");
   u00136 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00136, "hal__gpioS");
   ...
   u00140 : constant Version_32 := 16#60f690f8#;
   pragma Export (C, u00140, "peripheralsS");
