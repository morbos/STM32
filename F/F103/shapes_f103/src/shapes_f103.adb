...
--   DrawLine (Display, 10, 10, 110, 110, ST7735_BLUE);
--   DrawLine (Display, 110, 10, 10, 110, ST7735_GREEN);
--   DrawLine (Display, 110, 60, 10, 60, ST7735_PURPLE);
--   DrawLine (Display, 60, 10, 60, 110, ST7735_CYAN);
   DrawCircle (Display, 60, 60, 20, ST7735_CYAN);
   loop
      null;
   end loop;
end Shapes_F103;
