...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_dotstar_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#39064c7c#;
   pragma Export (C, u00001, "dotstar_f103B");
   ...
   u00070 : constant Version_32 := 16#5d29ed31#;
   pragma Export (C, u00070, "dotstarB");
   u00071 : constant Version_32 := 16#1e79925d#;
   pragma Export (C, u00071, "dotstarS");
   u00072 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00072, "ada__real_time__delaysB");
   u00073 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00073, "ada__real_time__delaysS");
   u00074 : constant Version_32 := 16#71f79a66#;
   pragma Export (C, u00074, "halS");
   u00075 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00075, "hal__spiS");
   ...
   u00113 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00113, "stm32__timersB");
   u00114 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00114, "stm32__timersS");
   u00115 : constant Version_32 := 16#af403693#;
   pragma Export (C, u00115, "stm32__usartsB");
   u00116 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00116, "stm32__usartsS");
   u00117 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00117, "stm32_svd__usartS");
   u00118 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00118, "hal__uartS");
   u00119 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00119, "stm32_svd__pwrS");
   u00120 : constant Version_32 := 16#ff4dd5b4#;
   pragma Export (C, u00120, "stm32__syscfgS");
   u00121 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00121, "stm32_svd__afioS");
   u00122 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00122, "stm32_svd__gpioS");
   u00123 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00123, "hal__gpioS");
   u00124 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00124, "stm32__extiB");
   u00125 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00125, "stm32__extiS");
   u00126 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00126, "stm32_svd__extiS");
   u00127 : constant Version_32 := 16#189dd11d#;
   pragma Export (C, u00127, "last_chance_handlerB");
   u00128 : constant Version_32 := 16#d1bc38d5#;
   pragma Export (C, u00128, "last_chance_handlerS");
   u00129 : constant Version_32 := 16#ab5f03f3#;
   pragma Export (C, u00129, "stm32__boardB");
   u00130 : constant Version_32 := 16#7398dfbc#;
   pragma Export (C, u00130, "stm32__boardS");
   u00131 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00131, "stm32__setupS");
   u00132 : constant Version_32 := 16#1c2d3a94#;
