...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_vl53l0x_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#25c627b4#;
   pragma Export (C, u00001, "vl53l0x_f103B");
   ...
   u00072 : constant Version_32 := 16#71f79a66#;
   pragma Export (C, u00072, "halS");
   u00073 : constant Version_32 := 16#189dd11d#;
   pragma Export (C, u00073, "last_chance_handlerB");
   u00074 : constant Version_32 := 16#d1bc38d5#;
   pragma Export (C, u00074, "last_chance_handlerS");
   u00075 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00075, "stm32S");
   u00076 : constant Version_32 := 16#ab5f03f3#;
   pragma Export (C, u00076, "stm32__boardB");
   u00077 : constant Version_32 := 16#7398dfbc#;
   pragma Export (C, u00077, "stm32__boardS");
   u00078 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00078, "stm32__setupS");
   u00079 : constant Version_32 := 16#089896ae#;
   pragma Export (C, u00079, "stm32__gpioB");
   u00080 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00080, "stm32__gpioS");
   u00081 : constant Version_32 := 16#bcd3cae4#;
   pragma Export (C, u00081, "stm32__afioB");
   u00082 : constant Version_32 := 16#1de8076d#;
   pragma Export (C, u00082, "stm32__afioS");
   u00083 : constant Version_32 := 16#61404bc6#;
   pragma Export (C, u00083, "stm32__deviceB");
   u00084 : constant Version_32 := 16#20e562e2#;
   pragma Export (C, u00084, "stm32__deviceS");
   u00085 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00085, "stm32_svdS");
   u00086 : constant Version_32 := 16#78b98332#;
   pragma Export (C, u00086, "stm32_svd__rccS");
   ...
   u00089 : constant Version_32 := 16#269d2c81#;
   pragma Export (C, u00089, "stm32__adcB");
   u00090 : constant Version_32 := 16#e6605efc#;
   pragma Export (C, u00090, "stm32__adcS");
   u00091 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00091, "stm32_svd__adcS");
   u00092 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00092, "stm32__crcB");
   u00093 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00093, "stm32__crcS");
   u00094 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00094, "stm32_svd__crcS");
   u00095 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00095, "stm32__dacB");
   u00096 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00096, "stm32__dacS");
   u00097 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00097, "stm32_svd__dacS");
   u00098 : constant Version_32 := 16#817a1cff#;
   pragma Export (C, u00098, "stm32__dmaB");
   u00099 : constant Version_32 := 16#5b75d000#;
   pragma Export (C, u00099, "stm32__dmaS");
   u00100 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00100, "stm32_svd__dmaS");
   u00101 : constant Version_32 := 16#29beb20a#;
   pragma Export (C, u00101, "stm32__i2cB");
   u00102 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00102, "stm32__i2cS");
   u00103 : constant Version_32 := 16#cde18a7d#;
   pragma Export (C, u00103, "stm32_svd__i2cS");
   u00104 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00104, "system__img_unsB");
   u00105 : constant Version_32 := 16#a09f88a5#;
   pragma Export (C, u00105, "system__img_unsS");
   u00106 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00106, "hal__i2cS");
   u00107 : constant Version_32 := 16#cc2a548f#;
   pragma Export (C, u00107, "stm32__i2sB");
   u00108 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00108, "stm32__i2sS");
   u00109 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00109, "hal__audioS");
   u00110 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00110, "stm32_svd__spiS");
   u00111 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00111, "stm32__rtcS");
   u00112 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00112, "hal__real_time_clockS");
   u00113 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00113, "stm32__spiB");
   u00114 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00114, "stm32__spiS");
   u00115 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00115, "hal__spiS");
   ...
   u00122 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00122, "stm32__extiB");
   u00123 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00123, "stm32__extiS");
   u00124 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00124, "stm32_svd__extiS");
   u00125 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00125, "stm32_svd__afioS");
   u00126 : constant Version_32 := 16#a71f2a10#;
   pragma Export (C, u00126, "stm32__rccB");
   u00127 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00127, "stm32__rccS");
   u00128 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00128, "stm32_svd__pwrS");
   u00129 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00129, "stm32_svd__gpioS");
   u00130 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00130, "hal__gpioS");
   u00131 : constant Version_32 := 16#09de7604#;
   pragma Export (C, u00131, "peripheralsS");
   u00132 : constant Version_32 := 16#e283b73d#;
   pragma Export (C, u00132, "stm32f1_exti_interruptsB");
   u00133 : constant Version_32 := 16#4a220680#;
   pragma Export (C, u00133, "stm32f1_exti_interruptsS");
   u00134 : constant Version_32 := 16#86882935#;
   pragma Export (C, u00134, "system__tasking__protected_objectsB");
   u00135 : constant Version_32 := 16#7670502d#;
   pragma Export (C, u00135, "system__tasking__protected_objectsS");
   u00136 : constant Version_32 := 16#800bd20c#;
   pragma Export (C, u00136, "ada__interruptsB");
   u00137 : constant Version_32 := 16#aa9baec2#;
   pragma Export (C, u00137, "ada__interruptsS");
   u00138 : constant Version_32 := 16#51078933#;
   pragma Export (C, u00138, "ada__task_identificationB");
   u00139 : constant Version_32 := 16#2232cf53#;
   pragma Export (C, u00139, "ada__task_identificationS");
   u00140 : constant Version_32 := 16#858ee8bc#;
   pragma Export (C, u00140, "system__tasking__restrictedS");
   u00141 : constant Version_32 := 16#c4977486#;
   pragma Export (C, u00141, "system__tasking__restricted__stagesB");
   u00142 : constant Version_32 := 16#57e13518#;
   pragma Export (C, u00142, "system__tasking__restricted__stagesS");
   u00143 : constant Version_32 := 16#0a6637d7#;
   pragma Export (C, u00143, "system__interruptsB");
   u00144 : constant Version_32 := 16#38e9971b#;
   pragma Export (C, u00144, "system__interruptsS");
   u00145 : constant Version_32 := 16#1ab029f2#;
   pragma Export (C, u00145, "system__tasking__protected_objects__single_entryB");
   u00146 : constant Version_32 := 16#c7328e25#;
   pragma Export (C, u00146, "system__tasking__protected_objects__single_entryS");
   u00147 : constant Version_32 := 16#1ff5c9d4#;
   pragma Export (C, u00147, "system__tasking__protected_objects__multiprocessorsB");
   u00148 : constant Version_32 := 16#01c3fc38#;
   pragma Export (C, u00148, "system__tasking__protected_objects__multiprocessorsS");
   u00149 : constant Version_32 := 16#21296f77#;
   pragma Export (C, u00149, "ada__interrupts__namesS");
   u00150 : constant Version_32 := 16#5f33bfac#;
   pragma Export (C, u00150, "vl53l0xB");
   u00151 : constant Version_32 := 16#8e1c06be#;
   pragma Export (C, u00151, "vl53l0xS");
   ...
   --  stm32f1_exti_interrupts%s
   --  stm32f1_exti_interrupts%b
   --  vl53l0x%s
   --  vl53l0x%b
   --  vl53l0x_f103%b
