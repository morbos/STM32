...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_trace_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#289b4a31#;
   pragma Export (C, u00001, "trace_f103B");
   ...
   u00064 : constant Version_32 := 16#e8b5ddbd#;
   pragma Export (C, u00064, "cortex_m_svdS");
   u00065 : constant Version_32 := 16#e4734a8d#;
   pragma Export (C, u00065, "cortex_m_svd__debugS");
   u00066 : constant Version_32 := 16#71f79a66#;
   pragma Export (C, u00066, "halS");
   u00067 : constant Version_32 := 16#c4791250#;
   pragma Export (C, u00067, "cortex_m_svd__dwtS");
   u00068 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00068, "stm32S");
   u00069 : constant Version_32 := 16#ab5f03f3#;
   pragma Export (C, u00069, "stm32__boardB");
   u00070 : constant Version_32 := 16#9826467f#;
   pragma Export (C, u00070, "stm32__boardS");
   u00071 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00071, "stm32__setupS");
   u00072 : constant Version_32 := 16#1fd5c97f#;
   pragma Export (C, u00072, "stm32__gpioB");
   u00073 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00073, "stm32__gpioS");
   u00074 : constant Version_32 := 16#4ca1b3d3#;
   pragma Export (C, u00074, "stm32__rccB");
   u00075 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00075, "stm32__rccS");
   u00076 : constant Version_32 := 16#59ea569b#;
   pragma Export (C, u00076, "stm32__deviceB");
   u00077 : constant Version_32 := 16#cb5bfb21#;
   pragma Export (C, u00077, "stm32__deviceS");
   u00078 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00078, "stm32_svdS");
   u00079 : constant Version_32 := 16#78b98332#;
   pragma Export (C, u00079, "stm32_svd__rccS");
   u00080 : constant Version_32 := 16#748adc27#;
   pragma Export (C, u00080, "system__assertionsB");
   u00081 : constant Version_32 := 16#c660e445#;
   pragma Export (C, u00081, "system__assertionsS");
   u00082 : constant Version_32 := 16#269d2c81#;
   pragma Export (C, u00082, "stm32__adcB");
   u00083 : constant Version_32 := 16#e6605efc#;
   pragma Export (C, u00083, "stm32__adcS");
   u00084 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00084, "ada__real_time__delaysB");
   u00085 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00085, "ada__real_time__delaysS");
   u00086 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00086, "stm32_svd__adcS");
   u00087 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00087, "stm32__crcB");
   u00088 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00088, "stm32__crcS");
   u00089 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00089, "stm32_svd__crcS");
   u00090 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00090, "stm32__dacB");
   u00091 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00091, "stm32__dacS");
   u00092 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00092, "stm32_svd__dacS");
   ...
   u00095 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00095, "stm32_svd__dmaS");
   u00096 : constant Version_32 := 16#c2002bc9#;
   pragma Export (C, u00096, "stm32__i2cB");
   u00097 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00097, "stm32__i2cS");
   u00098 : constant Version_32 := 16#cde18a7d#;
   pragma Export (C, u00098, "stm32_svd__i2cS");
   u00099 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00099, "system__img_unsB");
   u00100 : constant Version_32 := 16#a09f88a5#;
   pragma Export (C, u00100, "system__img_unsS");
   u00101 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00101, "hal__i2cS");
   u00102 : constant Version_32 := 16#2794cd4c#;
   pragma Export (C, u00102, "stm32__i2sB");
   u00103 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00103, "stm32__i2sS");
   u00104 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00104, "hal__audioS");
   u00105 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00105, "stm32_svd__spiS");
   u00106 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00106, "stm32__rtcS");
   u00107 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00107, "hal__real_time_clockS");
   u00108 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00108, "stm32__spiB");
   u00109 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00109, "stm32__spiS");
   u00110 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00110, "hal__spiS");
   u00111 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00111, "stm32__timersB");
   u00112 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00112, "stm32__timersS");
   u00113 : constant Version_32 := 16#44feaf50#;
   pragma Export (C, u00113, "stm32__usartsB");
   u00114 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00114, "stm32__usartsS");
   u00115 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00115, "stm32_svd__usartS");
   u00116 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00116, "hal__uartS");
   u00117 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00117, "stm32_svd__pwrS");
   u00118 : constant Version_32 := 16#ff4dd5b4#;
   pragma Export (C, u00118, "stm32__syscfgS");
   u00119 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00119, "stm32_svd__afioS");
   u00120 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00120, "stm32_svd__gpioS");
   u00121 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00121, "hal__gpioS");
   ...
   u00125 : constant Version_32 := 16#a863beb9#;
   pragma Export (C, u00125, "stm32_svd__dbgS");
