...
procedure Trace_F103 is
   ...
   type Port_T is array (1 .. 32) of UInt32; --  Fine tune this to a 'union' if needed
   ...
   begin
      ...
      ETM.CR := ETM_CR_ETMEN or ETM_CR_STALL_PROCESSOR or ETM_CR_BRANCH_OUTPUT;
