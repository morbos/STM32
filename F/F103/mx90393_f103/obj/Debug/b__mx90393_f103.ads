...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mx90393_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5cd9e0a9#;
   pragma Export (C, u00001, "mx90393_f103B");
   ...
   u00073 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00073, "hal__spiS");
   u00074 : constant Version_32 := 16#b22f64e2#;
   pragma Export (C, u00074, "mx90393_spiB");
   u00075 : constant Version_32 := 16#530da777#;
   pragma Export (C, u00075, "mx90393_spiS");
   u00076 : constant Version_32 := 16#bb200399#;
   pragma Export (C, u00076, "mx90393B");
   u00077 : constant Version_32 := 16#2c423438#;
   pragma Export (C, u00077, "mx90393S");
   u00078 : constant Version_32 := 16#6ef5f4a9#;
   pragma Export (C, u00078, "utilsB");
   u00079 : constant Version_32 := 16#815fae4c#;
   pragma Export (C, u00079, "utilsS");
   u00080 : constant Version_32 := 16#68584843#;
   pragma Export (C, u00080, "mx90393_spi_ioB");
   u00081 : constant Version_32 := 16#0805a800#;
   pragma Export (C, u00081, "mx90393_spi_ioS");
   u00082 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00082, "stm32S");
   u00083 : constant Version_32 := 16#1fd5c97f#;
   pragma Export (C, u00083, "stm32__gpioB");
   u00084 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00084, "stm32__gpioS");
   u00085 : constant Version_32 := 16#4ca1b3d3#;
   pragma Export (C, u00085, "stm32__rccB");
   u00086 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00086, "stm32__rccS");
   u00087 : constant Version_32 := 16#59ea569b#;
   pragma Export (C, u00087, "stm32__deviceB");
   u00088 : constant Version_32 := 16#cb5bfb21#;
   pragma Export (C, u00088, "stm32__deviceS");
   u00089 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00089, "stm32_svdS");
   u00090 : constant Version_32 := 16#78b98332#;
   pragma Export (C, u00090, "stm32_svd__rccS");
   u00091 : constant Version_32 := 16#748adc27#;
   pragma Export (C, u00091, "system__assertionsB");
   u00092 : constant Version_32 := 16#c660e445#;
   pragma Export (C, u00092, "system__assertionsS");
   u00093 : constant Version_32 := 16#269d2c81#;
   pragma Export (C, u00093, "stm32__adcB");
   u00094 : constant Version_32 := 16#e6605efc#;
   pragma Export (C, u00094, "stm32__adcS");
   u00095 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00095, "stm32_svd__adcS");
   u00096 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00096, "stm32__crcB");
   u00097 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00097, "stm32__crcS");
   u00098 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00098, "stm32_svd__crcS");
   u00099 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00099, "stm32__dacB");
   u00100 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00100, "stm32__dacS");
   u00101 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00101, "stm32_svd__dacS");
   u00102 : constant Version_32 := 16#817a1cff#;
   pragma Export (C, u00102, "stm32__dmaB");
   u00103 : constant Version_32 := 16#5b75d000#;
   pragma Export (C, u00103, "stm32__dmaS");
   u00104 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00104, "stm32_svd__dmaS");
   u00105 : constant Version_32 := 16#c2002bc9#;
   pragma Export (C, u00105, "stm32__i2cB");
   u00106 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00106, "stm32__i2cS");
   u00107 : constant Version_32 := 16#cde18a7d#;
   pragma Export (C, u00107, "stm32_svd__i2cS");
   u00108 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00108, "system__img_unsB");
   u00109 : constant Version_32 := 16#a09f88a5#;
   pragma Export (C, u00109, "system__img_unsS");
   u00110 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00110, "hal__i2cS");
   u00111 : constant Version_32 := 16#2794cd4c#;
   pragma Export (C, u00111, "stm32__i2sB");
   u00112 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00112, "stm32__i2sS");
   u00113 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00113, "hal__audioS");
   u00114 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00114, "stm32_svd__spiS");
   u00115 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00115, "stm32__rtcS");
   u00116 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00116, "hal__real_time_clockS");
   u00117 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00117, "stm32__spiB");
   u00118 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00118, "stm32__spiS");
   u00119 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00119, "stm32__timersB");
   u00120 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00120, "stm32__timersS");
   u00121 : constant Version_32 := 16#44feaf50#;
   pragma Export (C, u00121, "stm32__usartsB");
   u00122 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00122, "stm32__usartsS");
   u00123 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00123, "stm32_svd__usartS");
   u00124 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00124, "hal__uartS");
   u00125 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00125, "stm32_svd__pwrS");
   u00126 : constant Version_32 := 16#ff4dd5b4#;
   pragma Export (C, u00126, "stm32__syscfgS");
   u00127 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00127, "stm32_svd__afioS");
   u00128 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00128, "stm32_svd__gpioS");
   u00129 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00129, "hal__gpioS");
   u00130 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00130, "stm32__extiB");
   u00131 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00131, "stm32__extiS");
   u00132 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00132, "stm32_svd__extiS");
   u00133 : constant Version_32 := 16#86c32e9b#;
   pragma Export (C, u00133, "peripheralsS");
   u00134 : constant Version_32 := 16#ab5f03f3#;
   pragma Export (C, u00134, "stm32__boardB");
   u00135 : constant Version_32 := 16#9826467f#;
   pragma Export (C, u00135, "stm32__boardS");
   u00136 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00136, "stm32__setupS");
   u00137 : constant Version_32 := 16#6c2f8802#;
   pragma Export (C, u00137, "system__img_intB");
   u00138 : constant Version_32 := 16#09362813#;
   pragma Export (C, u00138, "system__img_intS");
