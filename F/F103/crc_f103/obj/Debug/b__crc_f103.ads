...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_crc_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#05f3e24c#;
   pragma Export (C, u00001, "crc_f103B");
   ...
   u00021 : constant Version_32 := 16#33c4bb84#;
   ...
   u00073 : constant Version_32 := 16#6041fb68#;
   pragma Export (C, u00073, "memory_transferS");
   u00074 : constant Version_32 := 16#800bd20c#;
   pragma Export (C, u00074, "ada__interruptsB");
   u00075 : constant Version_32 := 16#aa9baec2#;
   pragma Export (C, u00075, "ada__interruptsS");
   u00076 : constant Version_32 := 16#51078933#;
   pragma Export (C, u00076, "ada__task_identificationB");
   u00077 : constant Version_32 := 16#2232cf53#;
   pragma Export (C, u00077, "ada__task_identificationS");
   u00078 : constant Version_32 := 16#858ee8bc#;
   pragma Export (C, u00078, "system__tasking__restrictedS");
   u00079 : constant Version_32 := 16#c4977486#;
   pragma Export (C, u00079, "system__tasking__restricted__stagesB");
   u00080 : constant Version_32 := 16#57e13518#;
   pragma Export (C, u00080, "system__tasking__restricted__stagesS");
   u00081 : constant Version_32 := 16#0a6637d7#;
   pragma Export (C, u00081, "system__interruptsB");
   u00082 : constant Version_32 := 16#38e9971b#;
   pragma Export (C, u00082, "system__interruptsS");
   u00083 : constant Version_32 := 16#86882935#;
   pragma Export (C, u00083, "system__tasking__protected_objectsB");
   u00084 : constant Version_32 := 16#7670502d#;
   pragma Export (C, u00084, "system__tasking__protected_objectsS");
   u00085 : constant Version_32 := 16#1ab029f2#;
   pragma Export (C, u00085, "system__tasking__protected_objects__single_entryB");
   u00086 : constant Version_32 := 16#c7328e25#;
   pragma Export (C, u00086, "system__tasking__protected_objects__single_entryS");
   u00087 : constant Version_32 := 16#1ff5c9d4#;
   pragma Export (C, u00087, "system__tasking__protected_objects__multiprocessorsB");
   u00088 : constant Version_32 := 16#01c3fc38#;
   pragma Export (C, u00088, "system__tasking__protected_objects__multiprocessorsS");
   u00089 : constant Version_32 := 16#62535264#;
   pragma Export (C, u00089, "ada__interrupts__namesS");
   u00090 : constant Version_32 := 16#a5ab19aa#;
   pragma Export (C, u00090, "dma_interrupt_handlingB");
   u00091 : constant Version_32 := 16#ed65d6e8#;
   pragma Export (C, u00091, "dma_interrupt_handlingS");
   u00092 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00092, "stm32S");
   u00093 : constant Version_32 := 16#817a1cff#;
   pragma Export (C, u00093, "stm32__dmaB");
   u00094 : constant Version_32 := 16#5b75d000#;
   pragma Export (C, u00094, "stm32__dmaS");
   u00095 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00095, "stm32_svdS");
   u00096 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00096, "stm32_svd__dmaS");
   u00097 : constant Version_32 := 16#748adc27#;
   pragma Export (C, u00097, "system__assertionsB");
   u00098 : constant Version_32 := 16#c660e445#;
   pragma Export (C, u00098, "system__assertionsS");
   u00099 : constant Version_32 := 16#61404bc6#;
   pragma Export (C, u00099, "stm32__deviceB");
   u00100 : constant Version_32 := 16#20e562e2#;
   pragma Export (C, u00100, "stm32__deviceS");
   u00101 : constant Version_32 := 16#78b98332#;
   pragma Export (C, u00101, "stm32_svd__rccS");
   u00102 : constant Version_32 := 16#269d2c81#;
   pragma Export (C, u00102, "stm32__adcB");
   u00103 : constant Version_32 := 16#e6605efc#;
   pragma Export (C, u00103, "stm32__adcS");
   u00104 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00104, "stm32_svd__adcS");
   u00105 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00105, "stm32__crcB");
   u00106 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00106, "stm32__crcS");
   u00107 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00107, "stm32_svd__crcS");
   u00108 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00108, "stm32__dacB");
   u00109 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00109, "stm32__dacS");
   u00110 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00110, "stm32_svd__dacS");
   u00111 : constant Version_32 := 16#1fd5c97f#;
   pragma Export (C, u00111, "stm32__gpioB");
   u00112 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00112, "stm32__gpioS");
   u00113 : constant Version_32 := 16#a71f2a10#;
   pragma Export (C, u00113, "stm32__rccB");
   u00114 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00114, "stm32__rccS");
   u00115 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00115, "stm32_svd__pwrS");
   u00116 : constant Version_32 := 16#ff4dd5b4#;
   pragma Export (C, u00116, "stm32__syscfgS");
   u00117 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00117, "stm32_svd__afioS");
   u00118 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00118, "stm32_svd__gpioS");
   u00119 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00119, "hal__gpioS");
   u00120 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00120, "stm32__extiB");
   u00121 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00121, "stm32__extiS");
   u00122 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00122, "stm32_svd__extiS");
   u00123 : constant Version_32 := 16#2a35a0a9#;
   pragma Export (C, u00123, "stm32__i2cB");
   u00124 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00124, "stm32__i2cS");
   u00125 : constant Version_32 := 16#cde18a7d#;
   ...
   u00128 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00128, "hal__i2cS");
   u00129 : constant Version_32 := 16#cc2a548f#;
   pragma Export (C, u00129, "stm32__i2sB");
   u00130 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00130, "stm32__i2sS");
   u00131 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00131, "hal__audioS");
   u00132 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00132, "stm32_svd__spiS");
   u00133 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00133, "stm32__rtcS");
   u00134 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00134, "hal__real_time_clockS");
   u00135 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00135, "stm32__spiB");
   u00136 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00136, "stm32__spiS");
   u00137 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00137, "hal__spiS");
   u00138 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00138, "stm32__timersB");
   u00139 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00139, "stm32__timersS");
   u00140 : constant Version_32 := 16#af403693#;
   pragma Export (C, u00140, "stm32__usartsB");
   u00141 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00141, "stm32__usartsS");
   u00142 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00142, "stm32_svd__usartS");
   u00143 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00143, "hal__uartS");
   u00144 : constant Version_32 := 16#ab5f03f3#;
   pragma Export (C, u00144, "stm32__boardB");
   u00145 : constant Version_32 := 16#7398dfbc#;
   pragma Export (C, u00145, "stm32__boardS");
   u00146 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00146, "stm32__setupS");
   u00147 : constant Version_32 := 16#9344373f#;
   pragma Export (C, u00147, "stm32__crc__dmaB");
   u00148 : constant Version_32 := 16#42072bfb#;
   pragma Export (C, u00148, "stm32__crc__dmaS");
   ...
   --  stm32.dma%s
   --  stm32.dma%b
   --  dma_interrupt_handling%s
   --  dma_interrupt_handling%b
   --  stm32.exti%s
   --  stm32.exti%b
   --  stm32.gpio%s
   --  stm32.i2c%s
