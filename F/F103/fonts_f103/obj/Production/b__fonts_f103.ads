...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_fonts_f103" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3f77d0c5#;
   pragma Export (C, u00001, "fonts_f103B");
   ...
   u00070 : constant Version_32 := 16#a5acac30#;
   pragma Export (C, u00070, "fontsB");
   u00071 : constant Version_32 := 16#5b1feab9#;
   ...
   u00074 : constant Version_32 := 16#b080d524#;
   pragma Export (C, u00074, "st7735rB");
   u00075 : constant Version_32 := 16#15f8bab2#;
   pragma Export (C, u00075, "st7735rS");
   ...
   u00081 : constant Version_32 := 16#eae50723#;
   pragma Export (C, u00081, "soft_drawing_bitmapB");
   u00082 : constant Version_32 := 16#697d739d#;
   pragma Export (C, u00082, "soft_drawing_bitmapS");
   ...
   u00085 : constant Version_32 := 16#189dd11d#;
   pragma Export (C, u00085, "last_chance_handlerB");
   u00086 : constant Version_32 := 16#d1bc38d5#;
   pragma Export (C, u00086, "last_chance_handlerS");
   ...
   u00089 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00089, "stm32S");
   u00090 : constant Version_32 := 16#ab5f03f3#;
   pragma Export (C, u00090, "stm32__boardB");
   u00091 : constant Version_32 := 16#7398dfbc#;
   pragma Export (C, u00091, "stm32__boardS");
   u00092 : constant Version_32 := 16#6eca58e1#;
   pragma Export (C, u00092, "stm32__setupS");
   u00093 : constant Version_32 := 16#089896ae#;
   pragma Export (C, u00093, "stm32__gpioB");
   u00094 : constant Version_32 := 16#d14b8c45#;
   pragma Export (C, u00094, "stm32__gpioS");
   u00095 : constant Version_32 := 16#bcd3cae4#;
   pragma Export (C, u00095, "stm32__afioB");
   u00096 : constant Version_32 := 16#1de8076d#;
   pragma Export (C, u00096, "stm32__afioS");
   u00097 : constant Version_32 := 16#61404bc6#;
   pragma Export (C, u00097, "stm32__deviceB");
   u00098 : constant Version_32 := 16#20e562e2#;
   pragma Export (C, u00098, "stm32__deviceS");
   u00099 : constant Version_32 := 16#5340d707#;
   pragma Export (C, u00099, "stm32_svdS");
   u00100 : constant Version_32 := 16#78b98332#;
   pragma Export (C, u00100, "stm32_svd__rccS");
   u00101 : constant Version_32 := 16#269d2c81#;
   pragma Export (C, u00101, "stm32__adcB");
   u00102 : constant Version_32 := 16#e6605efc#;
   pragma Export (C, u00102, "stm32__adcS");
   u00103 : constant Version_32 := 16#7a710d0b#;
   pragma Export (C, u00103, "stm32_svd__adcS");
   u00104 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00104, "stm32__crcB");
   u00105 : constant Version_32 := 16#186e8887#;
   pragma Export (C, u00105, "stm32__crcS");
   u00106 : constant Version_32 := 16#97150874#;
   pragma Export (C, u00106, "stm32_svd__crcS");
   u00107 : constant Version_32 := 16#78602d2a#;
   pragma Export (C, u00107, "stm32__dacB");
   u00108 : constant Version_32 := 16#56967a8e#;
   pragma Export (C, u00108, "stm32__dacS");
   u00109 : constant Version_32 := 16#169d928b#;
   pragma Export (C, u00109, "stm32_svd__dacS");
   u00110 : constant Version_32 := 16#817a1cff#;
   pragma Export (C, u00110, "stm32__dmaB");
   u00111 : constant Version_32 := 16#5b75d000#;
   pragma Export (C, u00111, "stm32__dmaS");
   u00112 : constant Version_32 := 16#8a96fb27#;
   pragma Export (C, u00112, "stm32_svd__dmaS");
   u00113 : constant Version_32 := 16#29beb20a#;
   pragma Export (C, u00113, "stm32__i2cB");
   u00114 : constant Version_32 := 16#bd19315c#;
   pragma Export (C, u00114, "stm32__i2cS");
   u00115 : constant Version_32 := 16#cde18a7d#;
   pragma Export (C, u00115, "stm32_svd__i2cS");
   u00116 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00116, "system__img_unsB");
   u00117 : constant Version_32 := 16#a09f88a5#;
   pragma Export (C, u00117, "system__img_unsS");
   u00118 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00118, "hal__i2cS");
   u00119 : constant Version_32 := 16#cc2a548f#;
   pragma Export (C, u00119, "stm32__i2sB");
   u00120 : constant Version_32 := 16#76b6c69e#;
   pragma Export (C, u00120, "stm32__i2sS");
   u00121 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00121, "hal__audioS");
   u00122 : constant Version_32 := 16#4cefce65#;
   pragma Export (C, u00122, "stm32_svd__spiS");
   u00123 : constant Version_32 := 16#9def1522#;
   pragma Export (C, u00123, "stm32__rtcS");
   u00124 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00124, "hal__real_time_clockS");
   u00125 : constant Version_32 := 16#d974b410#;
   pragma Export (C, u00125, "stm32__spiB");
   u00126 : constant Version_32 := 16#e47e442a#;
   pragma Export (C, u00126, "stm32__spiS");
   u00127 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00127, "stm32__timersB");
   u00128 : constant Version_32 := 16#590bfb8e#;
   pragma Export (C, u00128, "stm32__timersS");
   u00129 : constant Version_32 := 16#af403693#;
   pragma Export (C, u00129, "stm32__usartsB");
   u00130 : constant Version_32 := 16#3d705160#;
   pragma Export (C, u00130, "stm32__usartsS");
   u00131 : constant Version_32 := 16#9f7216dd#;
   pragma Export (C, u00131, "stm32_svd__usartS");
   u00132 : constant Version_32 := 16#fec1deba#;
   pragma Export (C, u00132, "hal__uartS");
   u00133 : constant Version_32 := 16#48f027d6#;
   pragma Export (C, u00133, "stm32__extiB");
   u00134 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00134, "stm32__extiS");
   u00135 : constant Version_32 := 16#689a8f6b#;
   pragma Export (C, u00135, "stm32_svd__extiS");
   u00136 : constant Version_32 := 16#a6771d8f#;
   pragma Export (C, u00136, "stm32_svd__afioS");
   u00137 : constant Version_32 := 16#a71f2a10#;
   pragma Export (C, u00137, "stm32__rccB");
   u00138 : constant Version_32 := 16#593a7088#;
   pragma Export (C, u00138, "stm32__rccS");
   u00139 : constant Version_32 := 16#fb440e58#;
   pragma Export (C, u00139, "stm32_svd__pwrS");
   u00140 : constant Version_32 := 16#992d569d#;
   pragma Export (C, u00140, "stm32_svd__gpioS");
   u00141 : constant Version_32 := 16#5db60d92#;
   pragma Export (C, u00141, "peripheralsS");
   u00142 : constant Version_32 := 16#153ecc5d#;
   pragma Export (C, u00142, "ravenscar_timeB");
   u00143 : constant Version_32 := 16#8f0ab111#;
   pragma Export (C, u00143, "ravenscar_timeS");
