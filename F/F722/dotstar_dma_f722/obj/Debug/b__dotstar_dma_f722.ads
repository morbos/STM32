...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_dotstar_dma_f722" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#91ac518d#;
   pragma Export (C, u00001, "dotstar_dma_f722B");
   ...
   u00118 : constant Version_32 := 16#7f7173c0#;
   pragma Export (C, u00118, "dotstar_dmaB");
   u00119 : constant Version_32 := 16#5904280f#;
   pragma Export (C, u00119, "dotstar_dmaS");
   u00120 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00120, "ada__real_time__delaysB");
   u00121 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00121, "ada__real_time__delaysS");
   u00122 : constant Version_32 := 16#71f79a66#;
   pragma Export (C, u00122, "halS");
   u00123 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00123, "hal__spiS");
   ...
   u00127 : constant Version_32 := 16#77cfbaf2#;
   pragma Export (C, u00127, "system__finalization_mastersB");
   u00128 : constant Version_32 := 16#3dba810c#;
   ...
   u00130 : constant Version_32 := 16#939fc92d#;
   pragma Export (C, u00130, "system__img_boolS");
   u00131 : constant Version_32 := 16#9623954f#;
   ...
   u00133 : constant Version_32 := 16#29b4cb56#;
   ...
   u00135 : constant Version_32 := 16#45ab266b#;
   ...
   u00138 : constant Version_32 := 16#a66a0087#;
   pragma Export (C, u00138, "system__memoryB");
   u00139 : constant Version_32 := 16#3f3bdef2#;
   pragma Export (C, u00139, "system__memoryS");
   u00140 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00140, "stm32S");
   u00141 : constant Version_32 := 16#56f3ff8a#;
   pragma Export (C, u00141, "stm32__gpioB");
   u00142 : constant Version_32 := 16#07e54b7d#;
   pragma Export (C, u00142, "stm32__gpioS");
   u00143 : constant Version_32 := 16#39ea6a32#;
   pragma Export (C, u00143, "stm32__rccB");
   u00144 : constant Version_32 := 16#738b340d#;
   pragma Export (C, u00144, "stm32__rccS");
   u00145 : constant Version_32 := 16#7d435259#;
   pragma Export (C, u00145, "stm32_svdS");
   u00146 : constant Version_32 := 16#e2fc8a5e#;
   pragma Export (C, u00146, "stm32_svd__rccS");
   u00147 : constant Version_32 := 16#442bf12b#;
   pragma Export (C, u00147, "stm32__syscfgB");
   u00148 : constant Version_32 := 16#9876f55d#;
   pragma Export (C, u00148, "stm32__syscfgS");
   u00149 : constant Version_32 := 16#733a6488#;
   pragma Export (C, u00149, "stm32__deviceB");
   u00150 : constant Version_32 := 16#62381ce7#;
   pragma Export (C, u00150, "stm32__deviceS");
   ...
   u00153 : constant Version_32 := 16#a7b686cf#;
   pragma Export (C, u00153, "stm32__adcB");
   u00154 : constant Version_32 := 16#cfd99345#;
   pragma Export (C, u00154, "stm32__adcS");
   u00155 : constant Version_32 := 16#5a4402a1#;
   pragma Export (C, u00155, "stm32_svd__adcS");
   u00156 : constant Version_32 := 16#75fcf25b#;
   pragma Export (C, u00156, "stm32__dacB");
   u00157 : constant Version_32 := 16#c8e22624#;
   pragma Export (C, u00157, "stm32__dacS");
   u00158 : constant Version_32 := 16#2ae24b3a#;
   pragma Export (C, u00158, "stm32_svd__dacS");
   u00159 : constant Version_32 := 16#26fe9dce#;
   pragma Export (C, u00159, "stm32__dmaB");
   u00160 : constant Version_32 := 16#ccc3ecf7#;
   pragma Export (C, u00160, "stm32__dmaS");
   u00161 : constant Version_32 := 16#5d7c4e95#;
   pragma Export (C, u00161, "stm32_svd__dmaS");
   u00162 : constant Version_32 := 16#2adfaf3f#;
   pragma Export (C, u00162, "stm32__i2cB");
   u00163 : constant Version_32 := 16#ad1f6bcc#;
   pragma Export (C, u00163, "stm32__i2cS");
   u00164 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00164, "hal__i2cS");
   u00165 : constant Version_32 := 16#35505786#;
   pragma Export (C, u00165, "stm32_svd__i2cS");
   ...
   u00168 : constant Version_32 := 16#c0a8406e#;
   pragma Export (C, u00168, "stm32__i2sB");
   u00169 : constant Version_32 := 16#919d8aa5#;
   pragma Export (C, u00169, "stm32__i2sS");
   u00170 : constant Version_32 := 16#78066153#;
   pragma Export (C, u00170, "hal__audioS");
   u00171 : constant Version_32 := 16#e86c7717#;
   pragma Export (C, u00171, "stm32_svd__spiS");
   u00172 : constant Version_32 := 16#1c16e6c2#;
   pragma Export (C, u00172, "stm32__rtcB");
   u00173 : constant Version_32 := 16#0b03a019#;
   pragma Export (C, u00173, "stm32__rtcS");
   u00174 : constant Version_32 := 16#b697e7c4#;
   pragma Export (C, u00174, "hal__real_time_clockS");
   u00175 : constant Version_32 := 16#13d5c134#;
   pragma Export (C, u00175, "stm32__power_controlB");
   u00176 : constant Version_32 := 16#7680d164#;
   pragma Export (C, u00176, "stm32__power_controlS");
   u00177 : constant Version_32 := 16#bd62e5a8#;
   pragma Export (C, u00177, "stm32_svd__pwrS");
   u00178 : constant Version_32 := 16#4cbaa99f#;
   pragma Export (C, u00178, "stm32_svd__rtcS");
   u00179 : constant Version_32 := 16#50cf6a26#;
   pragma Export (C, u00179, "stm32__sdmmcB");
   u00180 : constant Version_32 := 16#a882515f#;
   pragma Export (C, u00180, "stm32__sdmmcS");
   u00181 : constant Version_32 := 16#a7b5bcf2#;
   pragma Export (C, u00181, "sdmmc_initB");
   u00182 : constant Version_32 := 16#d8292ff3#;
   pragma Export (C, u00182, "sdmmc_initS");
   u00183 : constant Version_32 := 16#8d0c8ff8#;
   pragma Export (C, u00183, "hal__sdmmcB");
   u00184 : constant Version_32 := 16#851dd1b9#;
   pragma Export (C, u00184, "hal__sdmmcS");
   u00185 : constant Version_32 := 16#b3888260#;
   pragma Export (C, u00185, "stm32_svd__sdmmcS");
   u00186 : constant Version_32 := 16#18b0e8d8#;
   pragma Export (C, u00186, "stm32__spiB");
   u00187 : constant Version_32 := 16#6efe7806#;
   pragma Export (C, u00187, "stm32__spiS");
   u00188 : constant Version_32 := 16#22ac8dee#;
   pragma Export (C, u00188, "stm32__timersB");
   u00189 : constant Version_32 := 16#77087ed0#;
   pragma Export (C, u00189, "stm32__timersS");
   u00190 : constant Version_32 := 16#d60a1709#;
   pragma Export (C, u00190, "stm32_svd__saiS");
   u00191 : constant Version_32 := 16#1194c66c#;
   pragma Export (C, u00191, "stm32__extiB");
   u00192 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00192, "stm32__extiS");
   u00193 : constant Version_32 := 16#1ffdeb8f#;
   pragma Export (C, u00193, "stm32_svd__extiS");
   u00194 : constant Version_32 := 16#1fef42b1#;
   pragma Export (C, u00194, "stm32_svd__syscfgS");
   u00195 : constant Version_32 := 16#d4474374#;
   pragma Export (C, u00195, "stm32_svd__gpioS");
   u00196 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00196, "hal__gpioS");
   u00197 : constant Version_32 := 16#cabb3aac#;
   pragma Export (C, u00197, "peripheralsS");
   u00198 : constant Version_32 := 16#f44fefcb#;
   pragma Export (C, u00198, "stm32__boardB");
   u00199 : constant Version_32 := 16#2ef7dd8f#;
   pragma Export (C, u00199, "stm32__boardS");
   u00200 : constant Version_32 := 16#800bd20c#;
   pragma Export (C, u00200, "ada__interruptsB");
   u00201 : constant Version_32 := 16#aa9baec2#;
   pragma Export (C, u00201, "ada__interruptsS");
   u00202 : constant Version_32 := 16#51078933#;
   pragma Export (C, u00202, "ada__task_identificationB");
   u00203 : constant Version_32 := 16#c0b969b7#;
   pragma Export (C, u00203, "ada__task_identificationS");
   u00204 : constant Version_32 := 16#0aae3e4f#;
   pragma Export (C, u00204, "system__tasking__restrictedS");
   u00205 : constant Version_32 := 16#3ef1c8c6#;
   pragma Export (C, u00205, "system__tasking__restricted__stagesB");
   u00206 : constant Version_32 := 16#57e13518#;
   pragma Export (C, u00206, "system__tasking__restricted__stagesS");
   u00207 : constant Version_32 := 16#0a6637d7#;
   pragma Export (C, u00207, "system__interruptsB");
   u00208 : constant Version_32 := 16#b82d4f91#;
   pragma Export (C, u00208, "system__interruptsS");
   u00209 : constant Version_32 := 16#86882935#;
   pragma Export (C, u00209, "system__tasking__protected_objectsB");
   u00210 : constant Version_32 := 16#f95086de#;
   pragma Export (C, u00210, "system__tasking__protected_objectsS");
   u00211 : constant Version_32 := 16#33544d54#;
   pragma Export (C, u00211, "system__tasking__protected_objects__single_entryB");
   u00212 : constant Version_32 := 16#2a5d26b8#;
   pragma Export (C, u00212, "system__tasking__protected_objects__single_entryS");
   u00213 : constant Version_32 := 16#1ff5c9d4#;
   pragma Export (C, u00213, "system__tasking__protected_objects__multiprocessorsB");
   u00214 : constant Version_32 := 16#01c3fc38#;
   pragma Export (C, u00214, "system__tasking__protected_objects__multiprocessorsS");
   u00215 : constant Version_32 := 16#b908c6aa#;
   pragma Export (C, u00215, "ada__interrupts__namesS");
