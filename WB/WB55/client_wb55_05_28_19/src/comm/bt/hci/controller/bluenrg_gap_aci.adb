...
package body Bluenrg_Gap_Aci is
   ...
   begin
      ...
      if Oob_Data /= null then
         Cp.Oob_Data := Oob_Data.all;
      end if;
   ...
   begin
      ...
      To_UInt8_From_UInt16 (Buffer (Integer (Idx)), Buffer (Integer (Idx + 1)), AdvIntervMin);
      Idx := Idx + 2;

      To_UInt8_From_UInt16 (Buffer (Integer (Idx)), Buffer (Integer (Idx + 1)), AdvIntervMax);
      Idx := Idx + 2;
      ...
      To_UInt8_From_UInt16 (Buffer (Integer (Idx)), Buffer (Integer (Idx + 1)), SlaveConnIntervMin);
      Idx := Idx + 2;

      To_UInt8_From_UInt16 (Buffer (Integer (Idx)), Buffer (Integer (Idx + 1)), SlaveConnIntervMax);
      Idx := Idx + 2;
