...
package SX1276 is
   ...
   type ModemStatus_Register is record
      SignalDetected       : Boolean;
      SignalSynchronized   : Boolean;
      RXOnGoing            : Boolean;
      HeaderInfoValid      : Boolean;
      ModemClear           : Boolean;
      CodingRate           : UInt3;
   end record
     with Size => 8;

   for ModemStatus_Register use record
      SignalDetected       at 0 range 0 .. 0;
      SignalSynchronized   at 0 range 1 .. 1;
      RXOnGoing            at 0 range 2 .. 2;
      HeaderInfoValid      at 0 range 3 .. 3;
      ModemClear           at 0 range 4 .. 4;
      CodingRate           at 0 range 5 .. 7;
   end record;
