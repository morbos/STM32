...
package body Bluenrg_Gatt_Aci is
   ...
   begin
      ...
      To_UInt8_From_UInt16 (Buffer (Integer (Idx) + 1), Buffer (Integer (Idx)), CharValueLen);
      Idx := Idx + 2;
   ...
   function Aci_Gatt_Write_Without_Response
     (Conn_Handle : UInt16;
      Attr_Handle : UInt16;
      Value_Len   : UInt8;
      Attr_Value  : DataBuffT) return BLE_Status_Code
   ...
   begin
      ...
      RqBuff        := (others => 0);
      Rq.Opcode.Ogf := OGF_VENDOR_CMD;
      Rq.Opcode.Ocf := OCF_GATT_WRITE_WITHOUT_RESPONSE;
      Rq.Cparam     := Buffer'Unchecked_Access;
      Rq.Clen       := Idx - 1;
      Rq.Event      := EVT_CMD_STATUS_CODE;
      Rq.Rparam     := StatBuf'Unchecked_Access;
   ...
   end Aci_Gatt_Write_Without_Response;
   ...
   is
      ...
      StatBuf : aliased DataBuffT;
      for Status'Address use StatBuf'Address;
      Cp      : Gatt_Disc_All_Charac_Of_Serv_Param;
   ...
   begin
      ...
      RqBuff := (others => 0);
      Rq.Opcode.Ogf := OGF_VENDOR_CMD;
      Rq.Opcode.Ocf := OCF_GATT_DISC_ALL_CHARAC_OF_SERV;
   ...
   end Aci_Gatt_Disc_All_Charac_Of_Serv;
   ...
   is
      ...
      StatBuf : aliased DataBuffT;
      for Status'Address use StatBuf'Address;
      Cp      : Gatt_Disc_All_Charac_Descriptors_Param;
      CpBuf   : aliased DataBuffT;
      for Cp'Alignment use 1;
      for Cp'Address use CpBuf'Address;
   begin
      Cp.Conn_Handle := Conn_Handle;
      Cp.Start_Char_Handle := Start_Char_Handle;
      Cp.End_Char_Handle := End_Char_Handle;

      RqBuff := (others => 0);
      Rq.Opcode.Ogf := OGF_VENDOR_CMD;
      Rq.Opcode.Ocf := OCF_GATT_DISC_ALL_CHARAC_DESCRIPTORS;
      Rq.Cparam := CpBuf'Unchecked_Access;
      Rq.Clen   := Cp'Size / 8;
      Rq.Rparam := StatBuf'Unchecked_Access;
      Rq.Rlen   := 1;
   ...
   end Aci_Gatt_Disc_All_Charac_Descriptors;
