...
--   type DataBuffT is new UInt8_Array (1 .. HCI_READ_PACKET_SIZE);
   ...
   EVT_ENCRYPT_CHANGE               : constant UInt8 := 16#08#;
   EVT_READ_REMOTE_VER_COMPLETE     : constant UInt8 := 16#0C#;
   EVT_NUM_COMP_PKTS                : constant UInt8 := 16#13#;
   EVT_DATA_BUFFER_OVERFLOW         : constant UInt8 := 16#1A#;
   EVT_ENCRYPT_KEY_REFRESH_COMPLETE : constant UInt8 := 16#30#;
