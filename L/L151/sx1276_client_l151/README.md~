...
- cd STM32/L/L073/sx1276_client_l073
- make
...
once built:
```
root@ubuntu:~/openocd-0.10.1/tcl# ../src/openocd -f board/ronothL073.cfg
```
...
```
Then start the debugger. Note the use of patched ELF32 #4 using the Ruby script in the make.

```
hedley@ubuntu:~/ada/STM32/L/L073/sx1276_client_l073% arm-eabi-gdb obj/Debug/sx1276_l073_4
...
(gdb) flash
...
(gdb) c
