...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_helper" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5520e24c#;
   pragma Export (C, u00001, "helperB");
   ...
   u00119 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00119, "stm32S");
   u00120 : constant Version_32 := 16#ccf4ae88#;
   pragma Export (C, u00120, "stm32__boardB");
   u00121 : constant Version_32 := 16#254fde3d#;
   pragma Export (C, u00121, "stm32__boardS");
   u00122 : constant Version_32 := 16#dd943c83#;
   pragma Export (C, u00122, "stm32__setupS");
   u00123 : constant Version_32 := 16#a96e5e5d#;
   pragma Export (C, u00123, "stm32__deviceB");
   u00124 : constant Version_32 := 16#8bd950fc#;
   pragma Export (C, u00124, "stm32__deviceS");
   u00125 : constant Version_32 := 16#a304bf33#;
   pragma Export (C, u00125, "stm32_svdS");
   u00126 : constant Version_32 := 16#84449f5e#;
   pragma Export (C, u00126, "stm32_svd__rccS");
   u00127 : constant Version_32 := 16#84ecf1eb#;
   pragma Export (C, u00127, "stm32__adcB");
   u00128 : constant Version_32 := 16#e0ee62e1#;
   pragma Export (C, u00128, "stm32__adcS");
   u00129 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00129, "ada__real_time__delaysB");
   u00130 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00130, "ada__real_time__delaysS");
   u00131 : constant Version_32 := 16#c72b3d09#;
   pragma Export (C, u00131, "stm32_svd__adcS");
   u00132 : constant Version_32 := 16#52f1910f#;
   pragma Export (C, u00132, "system__assertionsB");
   u00133 : constant Version_32 := 16#abcb9452#;
   pragma Export (C, u00133, "system__assertionsS");
   u00134 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00134, "stm32__crcB");
   u00135 : constant Version_32 := 16#0169c58f#;
   pragma Export (C, u00135, "stm32__crcS");
   u00136 : constant Version_32 := 16#7e562d48#;
   pragma Export (C, u00136, "stm32_svd__crcS");
   u00137 : constant Version_32 := 16#e481624e#;
   pragma Export (C, u00137, "stm32__dacB");
   u00138 : constant Version_32 := 16#a37032eb#;
   pragma Export (C, u00138, "stm32__dacS");
   u00139 : constant Version_32 := 16#fbc8100f#;
   pragma Export (C, u00139, "stm32_svd__dacS");
   u00140 : constant Version_32 := 16#78a75446#;
   pragma Export (C, u00140, "stm32__dmaB");
   u00141 : constant Version_32 := 16#194c91a7#;
   pragma Export (C, u00141, "stm32__dmaS");
   u00142 : constant Version_32 := 16#61e4fe5f#;
   pragma Export (C, u00142, "stm32_svd__dmaS");
   u00143 : constant Version_32 := 16#b72b5631#;
   pragma Export (C, u00143, "stm32__gpioB");
   u00144 : constant Version_32 := 16#e63de2c6#;
   pragma Export (C, u00144, "stm32__gpioS");
   u00145 : constant Version_32 := 16#81159258#;
   pragma Export (C, u00145, "stm32__rccB");
   u00146 : constant Version_32 := 16#738b340d#;
   pragma Export (C, u00146, "stm32__rccS");
   u00147 : constant Version_32 := 16#06a98a33#;
   pragma Export (C, u00147, "stm32__syscfgB");
   u00148 : constant Version_32 := 16#9876f55d#;
   pragma Export (C, u00148, "stm32__syscfgS");
   u00149 : constant Version_32 := 16#0b2850f0#;
   pragma Export (C, u00149, "stm32__extiB");
   u00150 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00150, "stm32__extiS");
   u00151 : constant Version_32 := 16#d5ea2931#;
   pragma Export (C, u00151, "stm32_svd__extiS");
   u00152 : constant Version_32 := 16#72c1c4f7#;
   pragma Export (C, u00152, "stm32_svd__syscfgS");
   u00153 : constant Version_32 := 16#ebd807a5#;
   pragma Export (C, u00153, "stm32_svd__gpioS");
   u00154 : constant Version_32 := 16#10558b11#;
   pragma Export (C, u00154, "ada__streamsB");
   u00155 : constant Version_32 := 16#7705e907#;
   pragma Export (C, u00155, "ada__streamsS");
   u00156 : constant Version_32 := 16#823e79d0#;
   pragma Export (C, u00156, "ada__io_exceptionsS");
   u00157 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00157, "hal__gpioS");
   u00158 : constant Version_32 := 16#77cfbaf2#;
   pragma Export (C, u00158, "system__finalization_mastersB");
   u00159 : constant Version_32 := 16#3dba810c#;
   ...
   u00161 : constant Version_32 := 16#939fc92d#;
   pragma Export (C, u00161, "system__img_boolS");
   u00162 : constant Version_32 := 16#9623954f#;
   ...
   u00164 : constant Version_32 := 16#29b4cb56#;
   ...
   u00166 : constant Version_32 := 16#45ab266b#;
   ...
   u00169 : constant Version_32 := 16#a66a0087#;
   pragma Export (C, u00169, "system__memoryB");
   u00170 : constant Version_32 := 16#3f3bdef2#;
   pragma Export (C, u00170, "system__memoryS");
   u00171 : constant Version_32 := 16#11f85980#;
   ...
   u00173 : constant Version_32 := 16#5c37ab0d#;
   pragma Export (C, u00173, "stm32__i2cB");
   u00174 : constant Version_32 := 16#63089794#;
   pragma Export (C, u00174, "stm32__i2cS");
   u00175 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00175, "hal__i2cS");
   u00176 : constant Version_32 := 16#250046b4#;
   pragma Export (C, u00176, "stm32_svd__i2cS");
   u00177 : constant Version_32 := 16#d213a809#;
   pragma Export (C, u00177, "stm32__spiB");
   u00178 : constant Version_32 := 16#8694d5b8#;
   pragma Export (C, u00178, "stm32__spiS");
   u00179 : constant Version_32 := 16#433dd96d#;
   pragma Export (C, u00179, "stm32_svd__spiS");
   u00180 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00180, "hal__spiS");
   u00181 : constant Version_32 := 16#97a26746#;
   pragma Export (C, u00181, "stm32__timersB");
   u00182 : constant Version_32 := 16#28dd7a8b#;
   pragma Export (C, u00182, "stm32__timersS");
   u00183 : constant Version_32 := 16#d938424d#;
   pragma Export (C, u00183, "stm32l4_timer_interruptsB");
   u00184 : constant Version_32 := 16#cac24fb3#;
   pragma Export (C, u00184, "stm32l4_timer_interruptsS");
   u00185 : constant Version_32 := 16#86882935#;
   pragma Export (C, u00185, "system__tasking__protected_objectsB");
   u00186 : constant Version_32 := 16#f95086de#;
   pragma Export (C, u00186, "system__tasking__protected_objectsS");
   u00187 : constant Version_32 := 16#800bd20c#;
   pragma Export (C, u00187, "ada__interruptsB");
   u00188 : constant Version_32 := 16#aa9baec2#;
   pragma Export (C, u00188, "ada__interruptsS");
   u00189 : constant Version_32 := 16#51078933#;
   pragma Export (C, u00189, "ada__task_identificationB");
   u00190 : constant Version_32 := 16#c0b969b7#;
   pragma Export (C, u00190, "ada__task_identificationS");
   u00191 : constant Version_32 := 16#0aae3e4f#;
   pragma Export (C, u00191, "system__tasking__restrictedS");
   u00192 : constant Version_32 := 16#3ef1c8c6#;
   pragma Export (C, u00192, "system__tasking__restricted__stagesB");
   u00193 : constant Version_32 := 16#57e13518#;
   pragma Export (C, u00193, "system__tasking__restricted__stagesS");
   u00194 : constant Version_32 := 16#0a6637d7#;
   pragma Export (C, u00194, "system__interruptsB");
   u00195 : constant Version_32 := 16#b82d4f91#;
   pragma Export (C, u00195, "system__interruptsS");
   u00196 : constant Version_32 := 16#33544d54#;
   pragma Export (C, u00196, "system__tasking__protected_objects__single_entryB");
   u00197 : constant Version_32 := 16#2a5d26b8#;
   pragma Export (C, u00197, "system__tasking__protected_objects__single_entryS");
   u00198 : constant Version_32 := 16#1ff5c9d4#;
   pragma Export (C, u00198, "system__tasking__protected_objects__multiprocessorsB");
   u00199 : constant Version_32 := 16#01c3fc38#;
   pragma Export (C, u00199, "system__tasking__protected_objects__multiprocessorsS");
   u00200 : constant Version_32 := 16#5b780bd9#;
   pragma Export (C, u00200, "ada__interrupts__namesS");
