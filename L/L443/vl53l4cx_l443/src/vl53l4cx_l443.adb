...
procedure VL53L4CX_l443 is
   Rs  : VL53L4CX_Ranging_Sensor (Selected_I2C_Port);
   Vlf : VL53L4CX_GPIO_Functionality := New_Sample_Ready;
...
begin
   ...
   --  medium and long distance modes. See the VL53L4CX datasheet for more
