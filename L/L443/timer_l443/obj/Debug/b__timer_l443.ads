...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_timer_l443" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#00f7ae86#;
   pragma Export (C, u00001, "timer_l443B");
   ...
   u00116 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00116, "stm32S");
   u00117 : constant Version_32 := 16#71f79a66#;
   pragma Export (C, u00117, "halS");
   u00118 : constant Version_32 := 16#ccf4ae88#;
   pragma Export (C, u00118, "stm32__boardB");
   u00119 : constant Version_32 := 16#254fde3d#;
   pragma Export (C, u00119, "stm32__boardS");
   u00120 : constant Version_32 := 16#dd943c83#;
   pragma Export (C, u00120, "stm32__setupS");
   u00121 : constant Version_32 := 16#a96e5e5d#;
   pragma Export (C, u00121, "stm32__deviceB");
   u00122 : constant Version_32 := 16#8bd950fc#;
   pragma Export (C, u00122, "stm32__deviceS");
   u00123 : constant Version_32 := 16#a304bf33#;
   pragma Export (C, u00123, "stm32_svdS");
   u00124 : constant Version_32 := 16#84449f5e#;
   pragma Export (C, u00124, "stm32_svd__rccS");
   u00125 : constant Version_32 := 16#84ecf1eb#;
   pragma Export (C, u00125, "stm32__adcB");
   u00126 : constant Version_32 := 16#e0ee62e1#;
   pragma Export (C, u00126, "stm32__adcS");
   u00127 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00127, "ada__real_time__delaysB");
   u00128 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00128, "ada__real_time__delaysS");
   u00129 : constant Version_32 := 16#c72b3d09#;
   pragma Export (C, u00129, "stm32_svd__adcS");
   u00130 : constant Version_32 := 16#52f1910f#;
   pragma Export (C, u00130, "system__assertionsB");
   u00131 : constant Version_32 := 16#abcb9452#;
   pragma Export (C, u00131, "system__assertionsS");
   u00132 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00132, "stm32__crcB");
   u00133 : constant Version_32 := 16#0169c58f#;
   pragma Export (C, u00133, "stm32__crcS");
   u00134 : constant Version_32 := 16#7e562d48#;
   pragma Export (C, u00134, "stm32_svd__crcS");
   u00135 : constant Version_32 := 16#e481624e#;
   pragma Export (C, u00135, "stm32__dacB");
   u00136 : constant Version_32 := 16#a37032eb#;
   pragma Export (C, u00136, "stm32__dacS");
   u00137 : constant Version_32 := 16#fbc8100f#;
   pragma Export (C, u00137, "stm32_svd__dacS");
   ...
   u00181 : constant Version_32 := 16#4665db55#;
   pragma Export (C, u00181, "stm32l4_timer_interruptsB");
   u00182 : constant Version_32 := 16#cac24fb3#;
   pragma Export (C, u00182, "stm32l4_timer_interruptsS");
   u00183 : constant Version_32 := 16#86882935#;
   pragma Export (C, u00183, "system__tasking__protected_objectsB");
   u00184 : constant Version_32 := 16#f95086de#;
   pragma Export (C, u00184, "system__tasking__protected_objectsS");
   u00185 : constant Version_32 := 16#800bd20c#;
   pragma Export (C, u00185, "ada__interruptsB");
   u00186 : constant Version_32 := 16#aa9baec2#;
   pragma Export (C, u00186, "ada__interruptsS");
   u00187 : constant Version_32 := 16#51078933#;
   pragma Export (C, u00187, "ada__task_identificationB");
   u00188 : constant Version_32 := 16#c0b969b7#;
   pragma Export (C, u00188, "ada__task_identificationS");
   u00189 : constant Version_32 := 16#0aae3e4f#;
   pragma Export (C, u00189, "system__tasking__restrictedS");
   u00190 : constant Version_32 := 16#3ef1c8c6#;
   pragma Export (C, u00190, "system__tasking__restricted__stagesB");
   u00191 : constant Version_32 := 16#57e13518#;
   pragma Export (C, u00191, "system__tasking__restricted__stagesS");
   u00192 : constant Version_32 := 16#0a6637d7#;
   pragma Export (C, u00192, "system__interruptsB");
   u00193 : constant Version_32 := 16#b82d4f91#;
   pragma Export (C, u00193, "system__interruptsS");
   u00194 : constant Version_32 := 16#33544d54#;
   pragma Export (C, u00194, "system__tasking__protected_objects__single_entryB");
   u00195 : constant Version_32 := 16#2a5d26b8#;
   pragma Export (C, u00195, "system__tasking__protected_objects__single_entryS");
   u00196 : constant Version_32 := 16#1ff5c9d4#;
   pragma Export (C, u00196, "system__tasking__protected_objects__multiprocessorsB");
   u00197 : constant Version_32 := 16#01c3fc38#;
   pragma Export (C, u00197, "system__tasking__protected_objects__multiprocessorsS");
   u00198 : constant Version_32 := 16#5b780bd9#;
   pragma Export (C, u00198, "ada__interrupts__namesS");
