...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#c71ec6d9#;
   pragma Export (C, u00001, "waveshare_epd_1_54B");
   ...
   u00119 : constant Version_32 := 16#4eefb187#;
   pragma Export (C, u00119, "hal__bitmapS");
   u00120 : constant Version_32 := 16#10558b11#;
   pragma Export (C, u00120, "ada__streamsB");
   u00121 : constant Version_32 := 16#7705e907#;
   pragma Export (C, u00121, "ada__streamsS");
   u00122 : constant Version_32 := 16#823e79d0#;
   pragma Export (C, u00122, "ada__io_exceptionsS");
   u00123 : constant Version_32 := 16#77cfbaf2#;
   pragma Export (C, u00123, "system__finalization_mastersB");
   u00124 : constant Version_32 := 16#3dba810c#;
   ...
   u00126 : constant Version_32 := 16#939fc92d#;
   pragma Export (C, u00126, "system__img_boolS");
   u00127 : constant Version_32 := 16#9623954f#;
   ...
   u00129 : constant Version_32 := 16#29b4cb56#;
   ...
   u00131 : constant Version_32 := 16#45ab266b#;
   ...
   u00134 : constant Version_32 := 16#a66a0087#;
   pragma Export (C, u00134, "system__memoryB");
   u00135 : constant Version_32 := 16#3f3bdef2#;
   pragma Export (C, u00135, "system__memoryS");
   u00136 : constant Version_32 := 16#d5515017#;
   pragma Export (C, u00136, "hal__spiS");
   u00137 : constant Version_32 := 16#64139ddb#;
   pragma Export (C, u00137, "peripheralsS");
   u00138 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00138, "stm32S");
   u00139 : constant Version_32 := 16#a96e5e5d#;
   pragma Export (C, u00139, "stm32__deviceB");
   u00140 : constant Version_32 := 16#19a6dc4d#;
   pragma Export (C, u00140, "stm32__deviceS");
   u00141 : constant Version_32 := 16#a304bf33#;
   pragma Export (C, u00141, "stm32_svdS");
   u00142 : constant Version_32 := 16#84449f5e#;
   pragma Export (C, u00142, "stm32_svd__rccS");
   u00143 : constant Version_32 := 16#84ecf1eb#;
   pragma Export (C, u00143, "stm32__adcB");
   u00144 : constant Version_32 := 16#e0ee62e1#;
   pragma Export (C, u00144, "stm32__adcS");
   u00145 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00145, "ada__real_time__delaysB");
   u00146 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00146, "ada__real_time__delaysS");
   u00147 : constant Version_32 := 16#c72b3d09#;
   pragma Export (C, u00147, "stm32_svd__adcS");
   u00148 : constant Version_32 := 16#52f1910f#;
   pragma Export (C, u00148, "system__assertionsB");
   u00149 : constant Version_32 := 16#abcb9452#;
   pragma Export (C, u00149, "system__assertionsS");
   u00150 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00150, "stm32__crcB");
   u00151 : constant Version_32 := 16#0169c58f#;
   pragma Export (C, u00151, "stm32__crcS");
   u00152 : constant Version_32 := 16#7e562d48#;
   pragma Export (C, u00152, "stm32_svd__crcS");
   u00153 : constant Version_32 := 16#e481624e#;
   pragma Export (C, u00153, "stm32__dacB");
   u00154 : constant Version_32 := 16#a37032eb#;
   pragma Export (C, u00154, "stm32__dacS");
   u00155 : constant Version_32 := 16#fbc8100f#;
   pragma Export (C, u00155, "stm32_svd__dacS");
   u00156 : constant Version_32 := 16#78a75446#;
   pragma Export (C, u00156, "stm32__dmaB");
   u00157 : constant Version_32 := 16#194c91a7#;
   pragma Export (C, u00157, "stm32__dmaS");
   u00158 : constant Version_32 := 16#61e4fe5f#;
   pragma Export (C, u00158, "stm32_svd__dmaS");
   u00159 : constant Version_32 := 16#b72b5631#;
   pragma Export (C, u00159, "stm32__gpioB");
   u00160 : constant Version_32 := 16#e63de2c6#;
   pragma Export (C, u00160, "stm32__gpioS");
   u00161 : constant Version_32 := 16#81159258#;
   pragma Export (C, u00161, "stm32__rccB");
   u00162 : constant Version_32 := 16#738b340d#;
   pragma Export (C, u00162, "stm32__rccS");
   u00163 : constant Version_32 := 16#06a98a33#;
   pragma Export (C, u00163, "stm32__syscfgB");
   u00164 : constant Version_32 := 16#9876f55d#;
   pragma Export (C, u00164, "stm32__syscfgS");
   u00165 : constant Version_32 := 16#0b2850f0#;
   pragma Export (C, u00165, "stm32__extiB");
   u00166 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00166, "stm32__extiS");
   u00167 : constant Version_32 := 16#d5ea2931#;
   pragma Export (C, u00167, "stm32_svd__extiS");
   u00168 : constant Version_32 := 16#72c1c4f7#;
   pragma Export (C, u00168, "stm32_svd__syscfgS");
   u00169 : constant Version_32 := 16#ebd807a5#;
   pragma Export (C, u00169, "stm32_svd__gpioS");
   u00170 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00170, "hal__gpioS");
   ...
   u00177 : constant Version_32 := 16#521aebaa#;
   pragma Export (C, u00177, "stm32__spiB");
   u00178 : constant Version_32 := 16#14eb5909#;
   pragma Export (C, u00178, "stm32__spiS");
   u00179 : constant Version_32 := 16#433dd96d#;
   pragma Export (C, u00179, "stm32_svd__spiS");
   u00180 : constant Version_32 := 16#97a26746#;
   pragma Export (C, u00180, "stm32__timersB");
   u00181 : constant Version_32 := 16#28dd7a8b#;
   pragma Export (C, u00181, "stm32__timersS");
   u00182 : constant Version_32 := 16#153ecc5d#;
   pragma Export (C, u00182, "ravenscar_timeB");
   u00183 : constant Version_32 := 16#8f0ab111#;
   pragma Export (C, u00183, "ravenscar_timeS");
   u00184 : constant Version_32 := 16#de6b94d9#;
   pragma Export (C, u00184, "hal__timeS");
   u00185 : constant Version_32 := 16#ccf4ae88#;
   pragma Export (C, u00185, "stm32__boardB");
   u00186 : constant Version_32 := 16#254fde3d#;
   pragma Export (C, u00186, "stm32__boardS");
   u00187 : constant Version_32 := 16#dd943c83#;
   pragma Export (C, u00187, "stm32__setupS");
   u00188 : constant Version_32 := 16#aaa05fe2#;
   pragma Export (C, u00188, "waveshare_1_54_spiB");
   u00189 : constant Version_32 := 16#08964c65#;
   pragma Export (C, u00189, "waveshare_1_54_spiS");
   u00190 : constant Version_32 := 16#b0b8b049#;
   pragma Export (C, u00190, "hal__framebufferS");
   u00191 : constant Version_32 := 16#dadb12ca#;
   pragma Export (C, u00191, "memory_mapped_bitmapB");
   u00192 : constant Version_32 := 16#b8d69c93#;
   pragma Export (C, u00192, "memory_mapped_bitmapS");
   u00193 : constant Version_32 := 16#07016f71#;
   pragma Export (C, u00193, "bitmap_color_conversionB");
   u00194 : constant Version_32 := 16#566ee026#;
   pragma Export (C, u00194, "bitmap_color_conversionS");
   u00195 : constant Version_32 := 16#eae50723#;
   pragma Export (C, u00195, "soft_drawing_bitmapB");
   u00196 : constant Version_32 := 16#697d739d#;
   pragma Export (C, u00196, "soft_drawing_bitmapS");
