...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_dotstar_dma_l443" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4c275815#;
   pragma Export (C, u00001, "dotstar_dma_l443B");
   ...
   u00128 : constant Version_32 := 16#939fc92d#;
   pragma Export (C, u00128, "system__img_boolS");
   u00129 : constant Version_32 := 16#9623954f#;
   ...
   u00131 : constant Version_32 := 16#29b4cb56#;
   ...
   u00133 : constant Version_32 := 16#45ab266b#;
   ...
   u00136 : constant Version_32 := 16#a66a0087#;
   pragma Export (C, u00136, "system__memoryB");
   u00137 : constant Version_32 := 16#3f3bdef2#;
   pragma Export (C, u00137, "system__memoryS");
   u00138 : constant Version_32 := 16#440c82c6#;
   pragma Export (C, u00138, "memory_transferS");
   u00139 : constant Version_32 := 16#800bd20c#;
   pragma Export (C, u00139, "ada__interruptsB");
   u00140 : constant Version_32 := 16#aa9baec2#;
   pragma Export (C, u00140, "ada__interruptsS");
   u00141 : constant Version_32 := 16#51078933#;
   pragma Export (C, u00141, "ada__task_identificationB");
   u00142 : constant Version_32 := 16#c0b969b7#;
   pragma Export (C, u00142, "ada__task_identificationS");
   u00143 : constant Version_32 := 16#0aae3e4f#;
   pragma Export (C, u00143, "system__tasking__restrictedS");
   u00144 : constant Version_32 := 16#3ef1c8c6#;
   pragma Export (C, u00144, "system__tasking__restricted__stagesB");
   u00145 : constant Version_32 := 16#57e13518#;
   pragma Export (C, u00145, "system__tasking__restricted__stagesS");
   u00146 : constant Version_32 := 16#0a6637d7#;
   pragma Export (C, u00146, "system__interruptsB");
   u00147 : constant Version_32 := 16#b82d4f91#;
   pragma Export (C, u00147, "system__interruptsS");
   u00148 : constant Version_32 := 16#86882935#;
   pragma Export (C, u00148, "system__tasking__protected_objectsB");
   u00149 : constant Version_32 := 16#f95086de#;
   pragma Export (C, u00149, "system__tasking__protected_objectsS");
   u00150 : constant Version_32 := 16#33544d54#;
   pragma Export (C, u00150, "system__tasking__protected_objects__single_entryB");
   u00151 : constant Version_32 := 16#2a5d26b8#;
   pragma Export (C, u00151, "system__tasking__protected_objects__single_entryS");
   u00152 : constant Version_32 := 16#1ff5c9d4#;
   pragma Export (C, u00152, "system__tasking__protected_objects__multiprocessorsB");
   u00153 : constant Version_32 := 16#01c3fc38#;
   pragma Export (C, u00153, "system__tasking__protected_objects__multiprocessorsS");
   u00154 : constant Version_32 := 16#5b780bd9#;
   pragma Export (C, u00154, "ada__interrupts__namesS");
   u00155 : constant Version_32 := 16#a5ab19aa#;
   pragma Export (C, u00155, "dma_interrupt_handlingB");
   u00156 : constant Version_32 := 16#d9c18a14#;
   pragma Export (C, u00156, "dma_interrupt_handlingS");
   u00157 : constant Version_32 := 16#1879b65d#;
   pragma Export (C, u00157, "stm32S");
   u00158 : constant Version_32 := 16#78a75446#;
   pragma Export (C, u00158, "stm32__dmaB");
   u00159 : constant Version_32 := 16#194c91a7#;
   pragma Export (C, u00159, "stm32__dmaS");
   u00160 : constant Version_32 := 16#a304bf33#;
   pragma Export (C, u00160, "stm32_svdS");
   u00161 : constant Version_32 := 16#61e4fe5f#;
   pragma Export (C, u00161, "stm32_svd__dmaS");
   u00162 : constant Version_32 := 16#52f1910f#;
   pragma Export (C, u00162, "system__assertionsB");
   u00163 : constant Version_32 := 16#abcb9452#;
   pragma Export (C, u00163, "system__assertionsS");
   u00164 : constant Version_32 := 16#a96e5e5d#;
   pragma Export (C, u00164, "stm32__deviceB");
   u00165 : constant Version_32 := 16#8bd950fc#;
   pragma Export (C, u00165, "stm32__deviceS");
   u00166 : constant Version_32 := 16#84449f5e#;
   pragma Export (C, u00166, "stm32_svd__rccS");
   u00167 : constant Version_32 := 16#84ecf1eb#;
   pragma Export (C, u00167, "stm32__adcB");
   u00168 : constant Version_32 := 16#e0ee62e1#;
   pragma Export (C, u00168, "stm32__adcS");
   u00169 : constant Version_32 := 16#6a4c6cb2#;
   pragma Export (C, u00169, "ada__real_time__delaysB");
   u00170 : constant Version_32 := 16#64efb39b#;
   pragma Export (C, u00170, "ada__real_time__delaysS");
   u00171 : constant Version_32 := 16#c72b3d09#;
   pragma Export (C, u00171, "stm32_svd__adcS");
   u00172 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00172, "stm32__crcB");
   u00173 : constant Version_32 := 16#0169c58f#;
   pragma Export (C, u00173, "stm32__crcS");
   u00174 : constant Version_32 := 16#7e562d48#;
   pragma Export (C, u00174, "stm32_svd__crcS");
   u00175 : constant Version_32 := 16#e481624e#;
   pragma Export (C, u00175, "stm32__dacB");
   u00176 : constant Version_32 := 16#a37032eb#;
   pragma Export (C, u00176, "stm32__dacS");
   u00177 : constant Version_32 := 16#fbc8100f#;
   pragma Export (C, u00177, "stm32_svd__dacS");
   u00178 : constant Version_32 := 16#b72b5631#;
   pragma Export (C, u00178, "stm32__gpioB");
   u00179 : constant Version_32 := 16#e63de2c6#;
   pragma Export (C, u00179, "stm32__gpioS");
   u00180 : constant Version_32 := 16#81159258#;
   pragma Export (C, u00180, "stm32__rccB");
   u00181 : constant Version_32 := 16#738b340d#;
   pragma Export (C, u00181, "stm32__rccS");
   u00182 : constant Version_32 := 16#06a98a33#;
   pragma Export (C, u00182, "stm32__syscfgB");
   u00183 : constant Version_32 := 16#9876f55d#;
   pragma Export (C, u00183, "stm32__syscfgS");
   u00184 : constant Version_32 := 16#0b2850f0#;
   pragma Export (C, u00184, "stm32__extiB");
   u00185 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00185, "stm32__extiS");
   u00186 : constant Version_32 := 16#d5ea2931#;
   pragma Export (C, u00186, "stm32_svd__extiS");
   u00187 : constant Version_32 := 16#72c1c4f7#;
   pragma Export (C, u00187, "stm32_svd__syscfgS");
   u00188 : constant Version_32 := 16#ebd807a5#;
   pragma Export (C, u00188, "stm32_svd__gpioS");
   u00189 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00189, "hal__gpioS");
   u00190 : constant Version_32 := 16#11f85980#;
   pragma Export (C, u00190, "system__stream_attributesB");
   u00191 : constant Version_32 := 16#8bc30a4e#;
   pragma Export (C, u00191, "system__stream_attributesS");
   u00192 : constant Version_32 := 16#5c37ab0d#;
   pragma Export (C, u00192, "stm32__i2cB");
   u00193 : constant Version_32 := 16#63089794#;
   pragma Export (C, u00193, "stm32__i2cS");
   u00194 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00194, "hal__i2cS");
   u00195 : constant Version_32 := 16#250046b4#;
   pragma Export (C, u00195, "stm32_svd__i2cS");
   u00196 : constant Version_32 := 16#d213a809#;
   pragma Export (C, u00196, "stm32__spiB");
   u00197 : constant Version_32 := 16#8694d5b8#;
   pragma Export (C, u00197, "stm32__spiS");
   u00198 : constant Version_32 := 16#433dd96d#;
   pragma Export (C, u00198, "stm32_svd__spiS");
   u00199 : constant Version_32 := 16#97a26746#;
   pragma Export (C, u00199, "stm32__timersB");
   u00200 : constant Version_32 := 16#28dd7a8b#;
   pragma Export (C, u00200, "stm32__timersS");
   u00201 : constant Version_32 := 16#9b383d0c#;
   pragma Export (C, u00201, "peripheralsS");
   u00202 : constant Version_32 := 16#007d2cb2#;
   pragma Export (C, u00202, "stm32__spi__dmaB");
   u00203 : constant Version_32 := 16#0e69ebde#;
   pragma Export (C, u00203, "stm32__spi__dmaS");
   u00204 : constant Version_32 := 16#ccf4ae88#;
   pragma Export (C, u00204, "stm32__boardB");
   u00205 : constant Version_32 := 16#254fde3d#;
   pragma Export (C, u00205, "stm32__boardS");
   u00206 : constant Version_32 := 16#dd943c83#;
   pragma Export (C, u00206, "stm32__setupS");
