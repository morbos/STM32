...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_dotstar_l443" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6e0d13f2#;
   pragma Export (C, u00001, "dotstar_l443B");
   ...
   u00013 : constant Version_32 := 16#2971f4b0#;
   ...
   u00016 : constant Version_32 := 16#c9b471f8#;
   ...
   u00023 : constant Version_32 := 16#5e5d8d0a#;
   ...
   u00043 : constant Version_32 := 16#76700b92#;
   ...
   u00118 : constant Version_32 := 16#5d29ed31#;
   pragma Export (C, u00118, "dotstarB");
   u00119 : constant Version_32 := 16#16018f91#;
   pragma Export (C, u00119, "dotstarS");
   ...
   u00141 : constant Version_32 := 16#673f6c65#;
   pragma Export (C, u00141, "stm32__gpioB");
   u00142 : constant Version_32 := 16#3629d892#;
   ...
   u00145 : constant Version_32 := 16#a304bf33#;
   pragma Export (C, u00145, "stm32_svdS");
   u00146 : constant Version_32 := 16#84449f5e#;
   ...
   u00149 : constant Version_32 := 16#a96e5e5d#;
   pragma Export (C, u00149, "stm32__deviceB");
   u00150 : constant Version_32 := 16#59f90eed#;
   pragma Export (C, u00150, "stm32__deviceS");
   u00151 : constant Version_32 := 16#531b88d3#;
   pragma Export (C, u00151, "stm32__adcB");
   u00152 : constant Version_32 := 16#37191bd9#;
   pragma Export (C, u00152, "stm32__adcS");
   u00153 : constant Version_32 := 16#10dc4431#;
   pragma Export (C, u00153, "stm32_svd__adcS");
   u00154 : constant Version_32 := 16#52f1910f#;
   pragma Export (C, u00154, "system__assertionsB");
   u00155 : constant Version_32 := 16#abcb9452#;
   pragma Export (C, u00155, "system__assertionsS");
   u00156 : constant Version_32 := 16#0512a1e8#;
   pragma Export (C, u00156, "stm32__crcB");
   u00157 : constant Version_32 := 16#0169c58f#;
   pragma Export (C, u00157, "stm32__crcS");
   u00158 : constant Version_32 := 16#7e562d48#;
   pragma Export (C, u00158, "stm32_svd__crcS");
   u00159 : constant Version_32 := 16#e481624e#;
   pragma Export (C, u00159, "stm32__dacB");
   u00160 : constant Version_32 := 16#a37032eb#;
   pragma Export (C, u00160, "stm32__dacS");
   u00161 : constant Version_32 := 16#fbc8100f#;
   pragma Export (C, u00161, "stm32_svd__dacS");
   u00162 : constant Version_32 := 16#9a4c71b3#;
   pragma Export (C, u00162, "stm32__dmaB");
   u00163 : constant Version_32 := 16#2de8cd5b#;
   pragma Export (C, u00163, "stm32__dmaS");
   u00164 : constant Version_32 := 16#61e4fe5f#;
   pragma Export (C, u00164, "stm32_svd__dmaS");
   u00165 : constant Version_32 := 16#5c37ab0d#;
   pragma Export (C, u00165, "stm32__i2cB");
   u00166 : constant Version_32 := 16#63089794#;
   pragma Export (C, u00166, "stm32__i2cS");
   u00167 : constant Version_32 := 16#2595f936#;
   pragma Export (C, u00167, "hal__i2cS");
   u00168 : constant Version_32 := 16#250046b4#;
   pragma Export (C, u00168, "stm32_svd__i2cS");
   ...
   u00171 : constant Version_32 := 16#12f050d7#;
   pragma Export (C, u00171, "stm32__spiB");
   u00172 : constant Version_32 := 16#b004ed01#;
   pragma Export (C, u00172, "stm32__spiS");
   u00173 : constant Version_32 := 16#433dd96d#;
   pragma Export (C, u00173, "stm32_svd__spiS");
   u00174 : constant Version_32 := 16#97a26746#;
   pragma Export (C, u00174, "stm32__timersB");
   u00175 : constant Version_32 := 16#28dd7a8b#;
   pragma Export (C, u00175, "stm32__timersS");
   u00176 : constant Version_32 := 16#0b2850f0#;
   pragma Export (C, u00176, "stm32__extiB");
   u00177 : constant Version_32 := 16#4e29fc64#;
   pragma Export (C, u00177, "stm32__extiS");
   u00178 : constant Version_32 := 16#d5ea2931#;
   pragma Export (C, u00178, "stm32_svd__extiS");
   u00179 : constant Version_32 := 16#72c1c4f7#;
   pragma Export (C, u00179, "stm32_svd__syscfgS");
   u00180 : constant Version_32 := 16#ebd807a5#;
   pragma Export (C, u00180, "stm32_svd__gpioS");
   u00181 : constant Version_32 := 16#3f21acb6#;
   pragma Export (C, u00181, "hal__gpioS");
   u00182 : constant Version_32 := 16#7dbc3fe1#;
   pragma Export (C, u00182, "peripheralsS");
   u00183 : constant Version_32 := 16#ccf4ae88#;
   pragma Export (C, u00183, "stm32__boardB");
   u00184 : constant Version_32 := 16#f55be469#;
   pragma Export (C, u00184, "stm32__boardS");
   u00185 : constant Version_32 := 16#dd943c83#;
   pragma Export (C, u00185, "stm32__setupS");
