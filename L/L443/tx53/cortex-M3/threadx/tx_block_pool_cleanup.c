...
TX_THREAD           *previous_thread;
    ...
    pool_ptr =  (TX_BLOCK_POOL *) thread_ptr -> tx_thread_suspend_control_block;
    ...
    if ((thread_ptr -> tx_thread_suspend_cleanup) && (pool_ptr) && (pool_ptr -> tx_block_pool_id == TX_BLOCK_POOL_ID))
    {
#endif
