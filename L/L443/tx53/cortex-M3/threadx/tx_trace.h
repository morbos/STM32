...
typedef struct TX_TRACE_OBJECT_REGISTRY_ENTRY_STRUCT
{
    ...
    UCHAR                                                   tx_trace_object_registry_entry_object_reserved1;    /* Should be zero           */ 
    UCHAR                                                   tx_trace_object_registry_entry_object_reserved2;    /* Should be zero           */ 
...
/* Trace Buffer Entry. The Trace Buffer Entry contains information about a particular
   event in the system. The high-level format of the Trace Buffer Entry is:
            ...
            [Thread Priority or         4           This 4-byte field contains the current thread pointer for interrupt
             Current Thread Ptr]                    events or the thread priority for thread events.
...
/* Event numbers 130-4095 are reserved for ThreadX, user event numbers start at 1025, as defined by the TX_TRACE_USER_EVENT_START 
   in tx_api.h.  */
