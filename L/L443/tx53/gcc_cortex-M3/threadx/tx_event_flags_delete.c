...
TX_EVENT_FLAGS_GROUP    *previous_group;
    ...
    TX_TRACE_IN_LINE_INSERT(TX_TRACE_EVENT_FLAGS_DELETE, group_ptr, &thread_ptr, 0, 0, TX_TRACE_EVENT_FLAGS_EVENTS)
    ...
    group_ptr -> tx_event_flags_group_id =  0;

    /* Decrement the number of event flag groups created.  */
    _tx_event_flags_created_count--;
    created_count =  _tx_event_flags_created_count;
