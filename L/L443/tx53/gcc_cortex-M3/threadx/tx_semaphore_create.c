...
TX_SEMAPHORE    *previous_semaphore;
    ...
    created_count =  _tx_semaphore_created_count++;
    ...
    TX_TRACE_IN_LINE_INSERT(TX_TRACE_SEMAPHORE_CREATE, semaphore_ptr, initial_count, &next_semaphore, 0, TX_TRACE_SEMAPHORE_EVENTS)
