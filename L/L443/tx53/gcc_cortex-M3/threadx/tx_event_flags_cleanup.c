...
TX_THREAD                   *previous_thread;
    ...
    if ((thread_ptr -> tx_thread_suspend_cleanup) && (group_ptr) && (group_ptr -> tx_event_flags_group_id == TX_EVENT_FLAGS_ID))
    {
#endif
        ...
        if ((suspended_count) && (suspension_head))
        {
        ...
        if (thread_ptr -> tx_thread_state == TX_EVENT_FLAG)
        {
            ...
            group_ptr -> tx_event_flags_group_performance_timeout_count++;
#endif
